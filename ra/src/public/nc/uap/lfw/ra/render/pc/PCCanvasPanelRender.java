 ...
 * 布局中的panel 渲染器
 */
public class PCCanvasPanelRender extends UILayoutPanelRender<UICanvasPanel, WebElement> {

	public PCCanvasPanelRender(UICanvasPanel uiEle, UIMeta uimeta, PageMeta pageMeta, UILayoutRender<? extends UILayout, ? extends WebElement> parentRender) {
	...
	protected String getSourceType(IEventSupport ele) {
		return LfwPageContext.SOURCE_TYPE_CANVASPANEL;
	}
