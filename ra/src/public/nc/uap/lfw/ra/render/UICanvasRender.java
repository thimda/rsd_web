 ...
 * @param <K>
 */
public abstract class UICanvasRender<T extends UIPanel, K extends WebElement> extends UILayoutRender<T, K> {

	public UICanvasRender(T uiEle, UIMeta uimeta, PageMeta pageMeta, UIRender<?, ?> parentRender) {
