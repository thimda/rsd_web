...
/**
 * @see nc.uap.lfw.ca.jdt.core.compiler.CategorizedProblem#getCategoryID()
 */
 ...
 * @see nc.uap.lfw.ca.jdt.core.compiler.IProblem#getID()
 * @return int
 */
public int getID() {
	return this.id;
 ...
 * @see nc.uap.lfw.ca.jdt.core.compiler.CategorizedProblem#getMarkerType()
 */
