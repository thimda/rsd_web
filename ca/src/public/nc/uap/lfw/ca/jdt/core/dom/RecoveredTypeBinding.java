...
class RecoveredTypeBinding implements ITypeBinding {
	...
	private nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding binding;
	...
	RecoveredTypeBinding(BindingResolver resolver, nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
		this.resolver = resolver;
