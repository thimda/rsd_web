...
import nc.uap.lfw.ca.internal.compiler.problem.AbortCompilationUnit;
...
import nc.uap.lfw.ca.jdt.core.compiler.InvalidInputException;
import nc.uap.lfw.ca.jdt.internal.compiler.ASTVisitor;
import nc.uap.lfw.ca.jdt.internal.compiler.CompilationResult;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.AND_AND_Expression;
...
import nc.uap.lfw.ca.jdt.internal.compiler.ast.AbstractVariableDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.AllocationExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Annotation;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.AnnotationMethodDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Argument;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ArrayAllocationExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ArrayInitializer;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ArrayQualifiedTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ArrayReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ArrayTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.AssertStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Assignment;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.BinaryExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Block;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.BreakStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.CaseStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.CastExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.CharLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ClassLiteralAccess;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.CombinedBinaryExpression;
...
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ConditionalExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ConstructorDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ContinueStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.DoStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.DoubleLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.EmptyStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.EqualExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ExplicitConstructorCall;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Expression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.FalseLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.FieldDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.FieldReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.FloatLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ForStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ForeachStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.IfStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ImportReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Initializer;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.InstanceOfExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.IntLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.IntLiteralMinValue;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Javadoc;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.LabeledStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.LocalDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.LongLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.LongLiteralMinValue;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.MarkerAnnotation;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.MemberValuePair;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.MessageSend;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.MethodDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.NameReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.NormalAnnotation;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.NullLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.OR_OR_Expression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.OperatorIds;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ParameterizedQualifiedTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ParameterizedSingleTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.PostfixExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.PrefixExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.QualifiedAllocationExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.QualifiedNameReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.QualifiedSuperReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.QualifiedThisReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.QualifiedTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.Reference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ReturnStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.SingleMemberAnnotation;
...
import nc.uap.lfw.ca.jdt.internal.compiler.ast.StringLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.SuperReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.SwitchStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.SynchronizedStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ThisReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.ThrowStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.TrueLiteral;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.TryStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.TypeDeclaration;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.TypeParameter;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.TypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.UnaryExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.WhileStatement;
...
import nc.uap.lfw.ca.jdt.internal.compiler.env.ICompilationUnit;
...
import nc.uap.lfw.ca.jdt.internal.compiler.parser.diagnose.DiagnoseParser;
import nc.uap.lfw.ca.jdt.internal.compiler.util.Messages;
import nc.uap.lfw.ca.jdt.internal.compiler.util.Util;
import nc.uap.lfw.ca.util.ConstantUtils;
...
public class Parser implements  ParserBasicInformation, TerminalTokens, OperatorIds, TypeIds {
	...
	private final static String READABLE_NAMES_FILE_NAME =
		ConstantUtils.READABLE_NAMES_PATH + READABLE_NAMES_FILE; //$NON-NLS-1$
	...
	public nc.uap.lfw.ca.jdt.internal.compiler.ReadManager readManager;
...
private final static void buildFile(String filename, List listToDump) {
	...
	LfwLogger.debug(filename + " creation complete");
}
...
private static void buildFileForReadableName(
	...
	for (; i < alreadyAdded.length; i++) {
		if(!alreadyAdded[i]) {
			LfwLogger.debug(newName[i] + " has no readable name");
		}
	}
...
private final static void buildFileForTable(String filename, char[] chars) {
	...
	LfwLogger.debug(filename + " creation complete"); //$NON-NLS-1$
}
...
//
//	//[eclipse.jdt.internal.compiler.parser.Parser.buildFilesFromLPG("d:/leapfrog/grammar/javadcl.java")]
//	char[] contents = CharOperation.NO_CHAR;
//	try {
//		contents = Util.getFileCharContent(new File(dataFilename), null);
//	} catch (IOException ex) {
//		LfwLogger.debug(Messages.parser_incorrectPath); 
//		return;
//	}
...
//
//	
//	LfwLogger.debug(Messages.parser_moveFiles); 
//}
...
protected static String[] readReadableNameTable(String filename) {
	...
	try {
		...
		LfwLogger.debug("Missing resource : " + filename.replace('.', '/') + ".properties for locale " + Locale.getDefault());
		LfwLogger.error(e.getMessage(), e);
		throw e;
	}
...
protected void consumeRule(int act) {
  switch ( act ) {
    case 30 : if (DEBUG) { LfwLogger.debug("Type ::= PrimitiveType"); }  //$NON-NLS-1$
		    consumePrimitiveType();  
			break;
 
    case 44 : if (DEBUG) { LfwLogger.debug("ReferenceType ::= ClassOrInterfaceType"); }  //$NON-NLS-1$
		    consumeReferenceType();   
			break;
 
    case 48 : if (DEBUG) { LfwLogger.debug("ClassOrInterface ::= Name"); }  //$NON-NLS-1$
		    consumeClassOrInterfaceName();   
			break;
 
    case 49 : if (DEBUG) { LfwLogger.debug("ClassOrInterface ::= GenericType DOT Name"); }  //$NON-NLS-1$
		    consumeClassOrInterface();   
			break;
 
    case 50 : if (DEBUG) { LfwLogger.debug("GenericType ::= ClassOrInterface TypeArguments"); }  //$NON-NLS-1$
		    consumeGenericType();   
			break;
 
    case 51 : if (DEBUG) { LfwLogger.debug("ArrayTypeWithTypeArgumentsName ::= GenericType DOT Name"); }  //$NON-NLS-1$
		    consumeArrayTypeWithTypeArgumentsName();   
			break;
 
    case 52 : if (DEBUG) { LfwLogger.debug("ArrayType ::= PrimitiveType Dims"); }  //$NON-NLS-1$
		    consumePrimitiveArrayType();   
			break;
 
    case 53 : if (DEBUG) { LfwLogger.debug("ArrayType ::= Name Dims"); }  //$NON-NLS-1$
		    consumeNameArrayType();   
			break;
 
    case 54 : if (DEBUG) { LfwLogger.debug("ArrayType ::= ArrayTypeWithTypeArgumentsName Dims"); }  //$NON-NLS-1$
		    consumeGenericTypeNameArrayType();   
			break;
 
    case 55 : if (DEBUG) { LfwLogger.debug("ArrayType ::= GenericType Dims"); }  //$NON-NLS-1$
		    consumeGenericTypeArrayType();   
			break;
 
    case 60 : if (DEBUG) { LfwLogger.debug("QualifiedName ::= Name DOT SimpleName"); }  //$NON-NLS-1$
		    consumeQualifiedName();  
			break;
 
    case 61 : if (DEBUG) { LfwLogger.debug("CompilationUnit ::= EnterCompilationUnit..."); }  //$NON-NLS-1$
		    consumeCompilationUnit();  
			break;
 
    case 62 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= PackageDeclaration"); }  //$NON-NLS-1$
		    consumeInternalCompilationUnit();  
			break;
 
    case 63 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= PackageDeclaration..."); }  //$NON-NLS-1$
		    consumeInternalCompilationUnit();  
			break;
 
    case 64 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= PackageDeclaration..."); }  //$NON-NLS-1$
		    consumeInternalCompilationUnitWithTypes();  
			break;
 
    case 65 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= PackageDeclaration..."); }  //$NON-NLS-1$
		    consumeInternalCompilationUnitWithTypes();  
			break;
 
    case 66 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= ImportDeclarations..."); }  //$NON-NLS-1$
		    consumeInternalCompilationUnit();  
			break;
 
    case 67 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= TypeDeclarations"); }  //$NON-NLS-1$
		    consumeInternalCompilationUnitWithTypes();  
			break;
 
    case 68 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::= ImportDeclarations..."); }  //$NON-NLS-1$
		    consumeInternalCompilationUnitWithTypes();  
			break;
 
    case 69 : if (DEBUG) { LfwLogger.debug("InternalCompilationUnit ::="); }  //$NON-NLS-1$
		    consumeEmptyInternalCompilationUnit();  
			break;
 
    case 70 : if (DEBUG) { LfwLogger.debug("ReduceImports ::="); }  //$NON-NLS-1$
		    consumeReduceImports();  
			break;
 
    case 71 : if (DEBUG) { LfwLogger.debug("EnterCompilationUnit ::="); }  //$NON-NLS-1$
		    consumeEnterCompilationUnit();  
			break;
 
    case 87 : if (DEBUG) { LfwLogger.debug("CatchHeader ::= catch LPAREN FormalParameter RPAREN..."); }  //$NON-NLS-1$
		    consumeCatchHeader();  
			break;
 
    case 89 : if (DEBUG) { LfwLogger.debug("ImportDeclarations ::= ImportDeclarations..."); }  //$NON-NLS-1$
		    consumeImportDeclarations();  
			break;
 
    case 91 : if (DEBUG) { LfwLogger.debug("TypeDeclarations ::= TypeDeclarations TypeDeclaration"); }  //$NON-NLS-1$
		    consumeTypeDeclarations();  
			break;
 
    case 92 : if (DEBUG) { LfwLogger.debug("PackageDeclaration ::= PackageDeclarationName SEMICOLON"); }  //$NON-NLS-1$
		     consumePackageDeclaration();  
			break;
 
    case 93 : if (DEBUG) { LfwLogger.debug("PackageDeclarationName ::= Modifiers package..."); }  //$NON-NLS-1$
		     consumePackageDeclarationNameWithModifiers();  
			break;
 
    case 94 : if (DEBUG) { LfwLogger.debug("PackageDeclarationName ::= PackageComment package Name"); }  //$NON-NLS-1$
		     consumePackageDeclarationName();  
			break;
 
    case 95 : if (DEBUG) { LfwLogger.debug("PackageComment ::="); }  //$NON-NLS-1$
		     consumePackageComment();  
			break;
 
    case 100 : if (DEBUG) { LfwLogger.debug("SingleTypeImportDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeImportDeclaration();  
			break;
 
    case 101 : if (DEBUG) { LfwLogger.debug("SingleTypeImportDeclarationName ::= import Name"); }  //$NON-NLS-1$
		    consumeSingleTypeImportDeclarationName();  
			break;
 
    case 102 : if (DEBUG) { LfwLogger.debug("TypeImportOnDemandDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeImportDeclaration();  
			break;
 
    case 103 : if (DEBUG) { LfwLogger.debug("TypeImportOnDemandDeclarationName ::= import Name DOT..."); }  //$NON-NLS-1$
		    consumeTypeImportOnDemandDeclarationName();  
			break;
 
     case 106 : if (DEBUG) { LfwLogger.debug("TypeDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyTypeDeclaration();  
			break;
 
    case 110 : if (DEBUG) { LfwLogger.debug("Modifiers ::= Modifiers Modifier"); }  //$NON-NLS-1$
		    consumeModifiers2();  
			break;
 
    case 122 : if (DEBUG) { LfwLogger.debug("Modifier ::= Annotation"); }  //$NON-NLS-1$
		    consumeAnnotationAsModifier();  
			break;
 
    case 123 : if (DEBUG) { LfwLogger.debug("ClassDeclaration ::= ClassHeader ClassBody"); }  //$NON-NLS-1$
		    consumeClassDeclaration();  
			break;
 
    case 124 : if (DEBUG) { LfwLogger.debug("ClassHeader ::= ClassHeaderName ClassHeaderExtendsopt..."); }  //$NON-NLS-1$
		    consumeClassHeader();  
			break;
 
    case 125 : if (DEBUG) { LfwLogger.debug("ClassHeaderName ::= ClassHeaderName1 TypeParameters"); }  //$NON-NLS-1$
		    consumeTypeHeaderNameWithTypeParameters();  
			break;
 
    case 127 : if (DEBUG) { LfwLogger.debug("ClassHeaderName1 ::= Modifiersopt class Identifier"); }  //$NON-NLS-1$
		    consumeClassHeaderName1();  
			break;
 
    case 128 : if (DEBUG) { LfwLogger.debug("ClassHeaderExtends ::= extends ClassType"); }  //$NON-NLS-1$
		    consumeClassHeaderExtends();  
			break;
 
    case 129 : if (DEBUG) { LfwLogger.debug("ClassHeaderImplements ::= implements InterfaceTypeList"); }  //$NON-NLS-1$
		    consumeClassHeaderImplements();  
			break;
 
    case 131 : if (DEBUG) { LfwLogger.debug("InterfaceTypeList ::= InterfaceTypeList COMMA..."); }  //$NON-NLS-1$
		    consumeInterfaceTypeList();  
			break;
 
    case 132 : if (DEBUG) { LfwLogger.debug("InterfaceType ::= ClassOrInterfaceType"); }  //$NON-NLS-1$
		    consumeInterfaceType();  
			break;
 
    case 135 : if (DEBUG) { LfwLogger.debug("ClassBodyDeclarations ::= ClassBodyDeclarations..."); }  //$NON-NLS-1$
		    consumeClassBodyDeclarations();  
			break;
 
    case 139 : if (DEBUG) { LfwLogger.debug("ClassBodyDeclaration ::= Diet NestedMethod..."); }  //$NON-NLS-1$
		    consumeClassBodyDeclaration();  
			break;
 
    case 140 : if (DEBUG) { LfwLogger.debug("Diet ::="); }  //$NON-NLS-1$
		    consumeDiet();  
			break;

    case 141 : if (DEBUG) { LfwLogger.debug("Initializer ::= Diet NestedMethod CreateInitializer..."); }  //$NON-NLS-1$
		    consumeClassBodyDeclaration();  
			break;
 
    case 142 : if (DEBUG) { LfwLogger.debug("CreateInitializer ::="); }  //$NON-NLS-1$
		    consumeCreateInitializer();  
			break;

    case 149 : if (DEBUG) { LfwLogger.debug("ClassMemberDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyTypeDeclaration();  
			break;

    case 152 : if (DEBUG) { LfwLogger.debug("FieldDeclaration ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeFieldDeclaration();  
			break;
 
    case 154 : if (DEBUG) { LfwLogger.debug("VariableDeclarators ::= VariableDeclarators COMMA..."); }  //$NON-NLS-1$
		    consumeVariableDeclarators();  
			break;
 
    case 157 : if (DEBUG) { LfwLogger.debug("EnterVariable ::="); }  //$NON-NLS-1$
		    consumeEnterVariable();  
			break;
 
    case 158 : if (DEBUG) { LfwLogger.debug("ExitVariableWithInitialization ::="); }  //$NON-NLS-1$
		    consumeExitVariableWithInitialization();  
			break;
 
    case 159 : if (DEBUG) { LfwLogger.debug("ExitVariableWithoutInitialization ::="); }  //$NON-NLS-1$
		    consumeExitVariableWithoutInitialization();  
			break;
 
    case 160 : if (DEBUG) { LfwLogger.debug("ForceNoDiet ::="); }  //$NON-NLS-1$
		    consumeForceNoDiet();  
			break;
 
    case 161 : if (DEBUG) { LfwLogger.debug("RestoreDiet ::="); }  //$NON-NLS-1$
		    consumeRestoreDiet();  
			break;
 
    case 166 : if (DEBUG) { LfwLogger.debug("MethodDeclaration ::= MethodHeader MethodBody"); }  //$NON-NLS-1$
		    // set to true to consume a method with a body
  consumeMethodDeclaration(true);   
			break;
 
    case 167 : if (DEBUG) { LfwLogger.debug("AbstractMethodDeclaration ::= MethodHeader SEMICOLON"); }  //$NON-NLS-1$
		    // set to false to consume a method without body
  consumeMethodDeclaration(false);  
			break;
 
    case 168 : if (DEBUG) { LfwLogger.debug("MethodHeader ::= MethodHeaderName FormalParameterListopt"); }  //$NON-NLS-1$
		    consumeMethodHeader();  
			break;
 
    case 169 : if (DEBUG) { LfwLogger.debug("MethodHeaderName ::= Modifiersopt TypeParameters Type..."); }  //$NON-NLS-1$
		    consumeMethodHeaderNameWithTypeParameters(false);  
			break;
 
    case 170 : if (DEBUG) { LfwLogger.debug("MethodHeaderName ::= Modifiersopt Type Identifier LPAREN"); }  //$NON-NLS-1$
		    consumeMethodHeaderName(false);  
			break;
 
    case 171 : if (DEBUG) { LfwLogger.debug("MethodHeaderRightParen ::= RPAREN"); }  //$NON-NLS-1$
		    consumeMethodHeaderRightParen();  
			break;
 
    case 172 : if (DEBUG) { LfwLogger.debug("MethodHeaderExtendedDims ::= Dimsopt"); }  //$NON-NLS-1$
		    consumeMethodHeaderExtendedDims();  
			break;
 
    case 173 : if (DEBUG) { LfwLogger.debug("MethodHeaderThrowsClause ::= throws ClassTypeList"); }  //$NON-NLS-1$
		    consumeMethodHeaderThrowsClause();  
			break;
 
    case 174 : if (DEBUG) { LfwLogger.debug("ConstructorHeader ::= ConstructorHeaderName..."); }  //$NON-NLS-1$
		    consumeConstructorHeader();  
			break;
 
    case 175 : if (DEBUG) { LfwLogger.debug("ConstructorHeaderName ::= Modifiersopt TypeParameters..."); }  //$NON-NLS-1$
		    consumeConstructorHeaderNameWithTypeParameters();  
			break;
 
    case 176 : if (DEBUG) { LfwLogger.debug("ConstructorHeaderName ::= Modifiersopt Identifier LPAREN"); }  //$NON-NLS-1$
		    consumeConstructorHeaderName();  
			break;
 
    case 178 : if (DEBUG) { LfwLogger.debug("FormalParameterList ::= FormalParameterList COMMA..."); }  //$NON-NLS-1$
		    consumeFormalParameterList();  
			break;
 
    case 179 : if (DEBUG) { LfwLogger.debug("FormalParameter ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeFormalParameter(false);  
			break;
 
    case 180 : if (DEBUG) { LfwLogger.debug("FormalParameter ::= Modifiersopt Type ELLIPSIS..."); }  //$NON-NLS-1$
		    consumeFormalParameter(true);  
			break;
 
    case 182 : if (DEBUG) { LfwLogger.debug("ClassTypeList ::= ClassTypeList COMMA ClassTypeElt"); }  //$NON-NLS-1$
		    consumeClassTypeList();  
			break;
 
    case 183 : if (DEBUG) { LfwLogger.debug("ClassTypeElt ::= ClassType"); }  //$NON-NLS-1$
		    consumeClassTypeElt();  
			break;
 
    case 184 : if (DEBUG) { LfwLogger.debug("MethodBody ::= NestedMethod LBRACE BlockStatementsopt..."); }  //$NON-NLS-1$
		    consumeMethodBody();  
			break;
 
    case 185 : if (DEBUG) { LfwLogger.debug("NestedMethod ::="); }  //$NON-NLS-1$
		    consumeNestedMethod();  
			break;
 
    case 186 : if (DEBUG) { LfwLogger.debug("StaticInitializer ::= StaticOnly Block"); }  //$NON-NLS-1$
		    consumeStaticInitializer();  
			break;

    case 187 : if (DEBUG) { LfwLogger.debug("StaticOnly ::= static"); }  //$NON-NLS-1$
		    consumeStaticOnly();  
			break;
 
    case 188 : if (DEBUG) { LfwLogger.debug("ConstructorDeclaration ::= ConstructorHeader MethodBody"); }  //$NON-NLS-1$
		    consumeConstructorDeclaration() ;  
			break;
 
    case 189 : if (DEBUG) { LfwLogger.debug("ConstructorDeclaration ::= ConstructorHeader SEMICOLON"); }  //$NON-NLS-1$
		    consumeInvalidConstructorDeclaration() ;  
			break;
 
    case 190 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= this LPAREN..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(0, THIS_CALL);  
			break;
 
    case 191 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= OnlyTypeArguments this"); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(0,THIS_CALL);  
			break;
 
    case 192 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= super LPAREN..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(0,SUPER_CALL);  
			break;
 
    case 193 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(0,SUPER_CALL);  
			break;
 
    case 194 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Primary DOT super..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(1, SUPER_CALL);  
			break;
 
    case 195 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Primary DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(1, SUPER_CALL);  
			break;
 
    case 196 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Name DOT super LPAREN"); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(2, SUPER_CALL);  
			break;
 
    case 197 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Name DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(2, SUPER_CALL);  
			break;
 
    case 198 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Primary DOT this..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(1, THIS_CALL);  
			break;
 
    case 199 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Primary DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(1, THIS_CALL);  
			break;
 
    case 200 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Name DOT this LPAREN"); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(2, THIS_CALL);  
			break;
 
    case 201 : if (DEBUG) { LfwLogger.debug("ExplicitConstructorInvocation ::= Name DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(2, THIS_CALL);  
			break;
 
    case 202 : if (DEBUG) { LfwLogger.debug("InterfaceDeclaration ::= InterfaceHeader InterfaceBody"); }  //$NON-NLS-1$
		    consumeInterfaceDeclaration();  
			break;
 
    case 203 : if (DEBUG) { LfwLogger.debug("InterfaceHeader ::= InterfaceHeaderName..."); }  //$NON-NLS-1$
		    consumeInterfaceHeader();  
			break;
 
    case 204 : if (DEBUG) { LfwLogger.debug("InterfaceHeaderName ::= InterfaceHeaderName1..."); }  //$NON-NLS-1$
		    consumeTypeHeaderNameWithTypeParameters();  
			break;
 
    case 206 : if (DEBUG) { LfwLogger.debug("InterfaceHeaderName1 ::= Modifiersopt interface..."); }  //$NON-NLS-1$
		    consumeInterfaceHeaderName1();  
			break;
 
    case 207 : if (DEBUG) { LfwLogger.debug("InterfaceHeaderExtends ::= extends InterfaceTypeList"); }  //$NON-NLS-1$
		    consumeInterfaceHeaderExtends();  
			break;
 
    case 210 : if (DEBUG) { LfwLogger.debug("InterfaceMemberDeclarations ::=..."); }  //$NON-NLS-1$
		    consumeInterfaceMemberDeclarations();  
			break;
 
    case 211 : if (DEBUG) { LfwLogger.debug("InterfaceMemberDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyTypeDeclaration();  
			break;
 
    case 213 : if (DEBUG) { LfwLogger.debug("InterfaceMemberDeclaration ::= MethodHeader MethodBody"); }  //$NON-NLS-1$
		    consumeInvalidMethodDeclaration();  
			break;
 
    case 214 : if (DEBUG) { LfwLogger.debug("InvalidConstructorDeclaration ::= ConstructorHeader..."); }  //$NON-NLS-1$
		    consumeInvalidConstructorDeclaration(true);   
			break;
 
    case 215 : if (DEBUG) { LfwLogger.debug("InvalidConstructorDeclaration ::= ConstructorHeader..."); }  //$NON-NLS-1$
		    consumeInvalidConstructorDeclaration(false);   
			break;
 
    case 223 : if (DEBUG) { LfwLogger.debug("PushLeftBrace ::="); }  //$NON-NLS-1$
		    consumePushLeftBrace();  
			break;
 
    case 224 : if (DEBUG) { LfwLogger.debug("ArrayInitializer ::= LBRACE PushLeftBrace ,opt RBRACE"); }  //$NON-NLS-1$
		    consumeEmptyArrayInitializer();  
			break;
 
    case 225 : if (DEBUG) { LfwLogger.debug("ArrayInitializer ::= LBRACE PushLeftBrace..."); }  //$NON-NLS-1$
		    consumeArrayInitializer();  
			break;
 
    case 226 : if (DEBUG) { LfwLogger.debug("ArrayInitializer ::= LBRACE PushLeftBrace..."); }  //$NON-NLS-1$
		    consumeArrayInitializer();  
			break;
 
    case 228 : if (DEBUG) { LfwLogger.debug("VariableInitializers ::= VariableInitializers COMMA..."); }  //$NON-NLS-1$
		    consumeVariableInitializers();  
			break;
 
    case 229 : if (DEBUG) { LfwLogger.debug("Block ::= OpenBlock LBRACE BlockStatementsopt RBRACE"); }  //$NON-NLS-1$
		    consumeBlock();  
			break;
 
    case 230 : if (DEBUG) { LfwLogger.debug("OpenBlock ::="); }  //$NON-NLS-1$
		    consumeOpenBlock() ;  
			break;
 
    case 232 : if (DEBUG) { LfwLogger.debug("BlockStatements ::= BlockStatements BlockStatement"); }  //$NON-NLS-1$
		    consumeBlockStatements() ;  
			break;
 
    case 236 : if (DEBUG) { LfwLogger.debug("BlockStatement ::= InterfaceDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidInterfaceDeclaration();  
			break;
 
    case 237 : if (DEBUG) { LfwLogger.debug("BlockStatement ::= AnnotationTypeDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidAnnotationTypeDeclaration();  
			break;
 
    case 238 : if (DEBUG) { LfwLogger.debug("BlockStatement ::= EnumDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidEnumDeclaration();  
			break;
 
    case 239 : if (DEBUG) { LfwLogger.debug("LocalVariableDeclarationStatement ::=..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclarationStatement();  
			break;
 
    case 240 : if (DEBUG) { LfwLogger.debug("LocalVariableDeclaration ::= Type PushModifiers..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclaration();  
			break;
 
    case 241 : if (DEBUG) { LfwLogger.debug("LocalVariableDeclaration ::= Modifiers Type..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclaration();  
			break;
 
    case 242 : if (DEBUG) { LfwLogger.debug("PushModifiers ::="); }  //$NON-NLS-1$
		    consumePushModifiers();  
			break;
 
    case 243 : if (DEBUG) { LfwLogger.debug("PushModifiersForHeader ::="); }  //$NON-NLS-1$
		    consumePushModifiersForHeader();  
			break;
 
    case 244 : if (DEBUG) { LfwLogger.debug("PushRealModifiers ::="); }  //$NON-NLS-1$
		    consumePushRealModifiers();  
			break;
 
    case 270 : if (DEBUG) { LfwLogger.debug("EmptyStatement ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyStatement();  
			break;
 
    case 271 : if (DEBUG) { LfwLogger.debug("LabeledStatement ::= Label COLON Statement"); }  //$NON-NLS-1$
		    consumeStatementLabel() ;  
			break;
 
    case 272 : if (DEBUG) { LfwLogger.debug("LabeledStatementNoShortIf ::= Label COLON..."); }  //$NON-NLS-1$
		    consumeStatementLabel() ;  
			break;
 
    case 273 : if (DEBUG) { LfwLogger.debug("Label ::= Identifier"); }  //$NON-NLS-1$
		    consumeLabel() ;  
			break;
 
     case 274 : if (DEBUG) { LfwLogger.debug("ExpressionStatement ::= StatementExpression SEMICOLON"); }  //$NON-NLS-1$
		    consumeExpressionStatement();  
			break;
 
    case 283 : if (DEBUG) { LfwLogger.debug("IfThenStatement ::= if LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementIfNoElse();  
			break;
 
    case 284 : if (DEBUG) { LfwLogger.debug("IfThenElseStatement ::= if LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementIfWithElse();  
			break;
 
    case 285 : if (DEBUG) { LfwLogger.debug("IfThenElseStatementNoShortIf ::= if LPAREN Expression..."); }  //$NON-NLS-1$
		    consumeStatementIfWithElse();  
			break;
 
    case 286 : if (DEBUG) { LfwLogger.debug("SwitchStatement ::= switch LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementSwitch() ;  
			break;
 
    case 287 : if (DEBUG) { LfwLogger.debug("SwitchBlock ::= LBRACE RBRACE"); }  //$NON-NLS-1$
		    consumeEmptySwitchBlock() ;  
			break;
 
    case 290 : if (DEBUG) { LfwLogger.debug("SwitchBlock ::= LBRACE SwitchBlockStatements..."); }  //$NON-NLS-1$
		    consumeSwitchBlock() ;  
			break;
 
    case 292 : if (DEBUG) { LfwLogger.debug("SwitchBlockStatements ::= SwitchBlockStatements..."); }  //$NON-NLS-1$
		    consumeSwitchBlockStatements() ;  
			break;
 
    case 293 : if (DEBUG) { LfwLogger.debug("SwitchBlockStatement ::= SwitchLabels BlockStatements"); }  //$NON-NLS-1$
		    consumeSwitchBlockStatement() ;  
			break;
 
    case 295 : if (DEBUG) { LfwLogger.debug("SwitchLabels ::= SwitchLabels SwitchLabel"); }  //$NON-NLS-1$
		    consumeSwitchLabels() ;  
			break;
 
     case 296 : if (DEBUG) { LfwLogger.debug("SwitchLabel ::= case ConstantExpression COLON"); }  //$NON-NLS-1$
		    consumeCaseLabel();  
			break;
 
     case 297 : if (DEBUG) { LfwLogger.debug("SwitchLabel ::= default COLON"); }  //$NON-NLS-1$
		    consumeDefaultLabel();  
			break;
 
    case 298 : if (DEBUG) { LfwLogger.debug("WhileStatement ::= while LPAREN Expression RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementWhile() ;  
			break;
 
    case 299 : if (DEBUG) { LfwLogger.debug("WhileStatementNoShortIf ::= while LPAREN Expression..."); }  //$NON-NLS-1$
		    consumeStatementWhile() ;  
			break;
 
    case 300 : if (DEBUG) { LfwLogger.debug("DoStatement ::= do Statement while LPAREN Expression..."); }  //$NON-NLS-1$
		    consumeStatementDo() ;  
			break;
 
    case 301 : if (DEBUG) { LfwLogger.debug("ForStatement ::= for LPAREN ForInitopt SEMICOLON..."); }  //$NON-NLS-1$
		    consumeStatementFor() ;  
			break;
 
    case 302 : if (DEBUG) { LfwLogger.debug("ForStatementNoShortIf ::= for LPAREN ForInitopt..."); }  //$NON-NLS-1$
		    consumeStatementFor() ;  
			break;
 
    case 303 : if (DEBUG) { LfwLogger.debug("ForInit ::= StatementExpressionList"); }  //$NON-NLS-1$
		    consumeForInit() ;  
			break;
 
    case 307 : if (DEBUG) { LfwLogger.debug("StatementExpressionList ::= StatementExpressionList..."); }  //$NON-NLS-1$
		    consumeStatementExpressionList() ;  
			break;
 
    case 308 : if (DEBUG) { LfwLogger.debug("AssertStatement ::= assert Expression SEMICOLON"); }  //$NON-NLS-1$
		    consumeSimpleAssertStatement() ;  
			break;
 
    case 309 : if (DEBUG) { LfwLogger.debug("AssertStatement ::= assert Expression COLON Expression"); }  //$NON-NLS-1$
		    consumeAssertStatement() ;  
			break;
 
    case 310 : if (DEBUG) { LfwLogger.debug("BreakStatement ::= break SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreak() ;  
			break;
 
    case 311 : if (DEBUG) { LfwLogger.debug("BreakStatement ::= break Identifier SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;  
			break;
 
    case 312 : if (DEBUG) { LfwLogger.debug("ContinueStatement ::= continue SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementContinue() ;  
			break;
 
    case 313 : if (DEBUG) { LfwLogger.debug("ContinueStatement ::= continue Identifier SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementContinueWithLabel() ;  
			break;
 
    case 314 : if (DEBUG) { LfwLogger.debug("ReturnStatement ::= return Expressionopt SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementReturn() ;  
			break;
 
    case 315 : if (DEBUG) { LfwLogger.debug("ThrowStatement ::= throw Expression SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementThrow();  
			break;
 
    case 316 : if (DEBUG) { LfwLogger.debug("SynchronizedStatement ::= OnlySynchronized LPAREN..."); }  //$NON-NLS-1$
		    consumeStatementSynchronized();  
			break;
 
    case 317 : if (DEBUG) { LfwLogger.debug("OnlySynchronized ::= synchronized"); }  //$NON-NLS-1$
		    consumeOnlySynchronized();  
			break;
 
    case 318 : if (DEBUG) { LfwLogger.debug("TryStatement ::= try TryBlock Catches"); }  //$NON-NLS-1$
		    consumeStatementTry(false);  
			break;
 
    case 319 : if (DEBUG) { LfwLogger.debug("TryStatement ::= try TryBlock Catchesopt Finally"); }  //$NON-NLS-1$
		    consumeStatementTry(true);  
			break;
 
    case 321 : if (DEBUG) { LfwLogger.debug("ExitTryBlock ::="); }  //$NON-NLS-1$
		    consumeExitTryBlock();  
			break;
 
    case 323 : if (DEBUG) { LfwLogger.debug("Catches ::= Catches CatchClause"); }  //$NON-NLS-1$
		    consumeCatches();  
			break;
 
    case 324 : if (DEBUG) { LfwLogger.debug("CatchClause ::= catch LPAREN FormalParameter RPAREN..."); }  //$NON-NLS-1$
		    consumeStatementCatch() ;  
			break;
 
    case 326 : if (DEBUG) { LfwLogger.debug("PushLPAREN ::= LPAREN"); }  //$NON-NLS-1$
		    consumeLeftParen();  
			break;
 
    case 327 : if (DEBUG) { LfwLogger.debug("PushRPAREN ::= RPAREN"); }  //$NON-NLS-1$
		    consumeRightParen();  
			break;
 
    case 332 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= this"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayThis();  
			break;
 
    case 333 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= PushLPAREN Expression_NotName..."); }  //$NON-NLS-1$
		    consumePrimaryNoNewArray();  
			break;
 
    case 334 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= PushLPAREN Name PushRPAREN"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayWithName();  
			break;
 
    case 337 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= Name DOT this"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayNameThis();  
			break;
 
    case 338 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= Name DOT super"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayNameSuper();  
			break;
 
    case 339 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= Name DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayName();  
			break;
 
    case 340 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= Name Dims DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayArrayType();  
			break;
 
    case 341 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= PrimitiveType Dims DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayPrimitiveArrayType();  
			break;
 
    case 342 : if (DEBUG) { LfwLogger.debug("PrimaryNoNewArray ::= PrimitiveType DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayPrimitiveType();  
			break;
 
    case 345 : if (DEBUG) { LfwLogger.debug("AllocationHeader ::= new ClassType LPAREN..."); }  //$NON-NLS-1$
		    consumeAllocationHeader();  
			break;
 
    case 346 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::= new..."); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionWithTypeArguments();  
			break;
 
    case 347 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::= new ClassType LPAREN"); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpression();  
			break;
 
    case 348 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::= Primary DOT new..."); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionQualifiedWithTypeArguments() ;  
			break;
 
    case 349 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::= Primary DOT new..."); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionQualified() ;  
			break;
 
    case 350 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::=..."); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionQualified() ;  
			break;
 
    case 351 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpression ::=..."); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionQualifiedWithTypeArguments() ;  
			break;
 
    case 352 : if (DEBUG) { LfwLogger.debug("ClassInstanceCreationExpressionName ::= Name DOT"); }  //$NON-NLS-1$
		    consumeClassInstanceCreationExpressionName() ;  
			break;
 
    case 353 : if (DEBUG) { LfwLogger.debug("ClassBodyopt ::="); }  //$NON-NLS-1$
		    consumeClassBodyopt();  
			break;
 
    case 355 : if (DEBUG) { LfwLogger.debug("EnterAnonymousClassBody ::="); }  //$NON-NLS-1$
		    consumeEnterAnonymousClassBody();  
			break;
 
    case 357 : if (DEBUG) { LfwLogger.debug("ArgumentList ::= ArgumentList COMMA Expression"); }  //$NON-NLS-1$
		    consumeArgumentList();  
			break;
 
    case 358 : if (DEBUG) { LfwLogger.debug("ArrayCreationHeader ::= new PrimitiveType..."); }  //$NON-NLS-1$
		    consumeArrayCreationHeader();  
			break;
 
    case 359 : if (DEBUG) { LfwLogger.debug("ArrayCreationHeader ::= new ClassOrInterfaceType..."); }  //$NON-NLS-1$
		    consumeArrayCreationHeader();  
			break;
 
    case 360 : if (DEBUG) { LfwLogger.debug("ArrayCreationWithoutArrayInitializer ::= new..."); }  //$NON-NLS-1$
		    consumeArrayCreationExpressionWithoutInitializer();  
			break;
 
    case 361 : if (DEBUG) { LfwLogger.debug("ArrayCreationWithArrayInitializer ::= new PrimitiveType"); }  //$NON-NLS-1$
		    consumeArrayCreationExpressionWithInitializer();  
			break;
 
    case 362 : if (DEBUG) { LfwLogger.debug("ArrayCreationWithoutArrayInitializer ::= new..."); }  //$NON-NLS-1$
		    consumeArrayCreationExpressionWithoutInitializer();  
			break;
 
    case 363 : if (DEBUG) { LfwLogger.debug("ArrayCreationWithArrayInitializer ::= new..."); }  //$NON-NLS-1$
		    consumeArrayCreationExpressionWithInitializer();  
			break;
 
    case 365 : if (DEBUG) { LfwLogger.debug("DimWithOrWithOutExprs ::= DimWithOrWithOutExprs..."); }  //$NON-NLS-1$
		    consumeDimWithOrWithOutExprs();  
			break;
 
     case 367 : if (DEBUG) { LfwLogger.debug("DimWithOrWithOutExpr ::= LBRACKET RBRACKET"); }  //$NON-NLS-1$
		    consumeDimWithOrWithOutExpr();  
			break;
 
     case 368 : if (DEBUG) { LfwLogger.debug("Dims ::= DimsLoop"); }  //$NON-NLS-1$
		    consumeDims();  
			break;
 
     case 371 : if (DEBUG) { LfwLogger.debug("OneDimLoop ::= LBRACKET RBRACKET"); }  //$NON-NLS-1$
		    consumeOneDimLoop();  
			break;
 
    case 372 : if (DEBUG) { LfwLogger.debug("FieldAccess ::= Primary DOT Identifier"); }  //$NON-NLS-1$
		    consumeFieldAccess(false);  
			break;
 
    case 373 : if (DEBUG) { LfwLogger.debug("FieldAccess ::= super DOT Identifier"); }  //$NON-NLS-1$
		    consumeFieldAccess(true);  
			break;
 
    case 374 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= Name LPAREN ArgumentListopt RPAREN"); }  //$NON-NLS-1$
		    consumeMethodInvocationName();  
			break;
 
    case 375 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= Name DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationNameWithTypeArguments();  
			break;
 
    case 376 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= Primary DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationPrimaryWithTypeArguments();  
			break;
 
    case 377 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= Primary DOT Identifier LPAREN..."); }  //$NON-NLS-1$
		    consumeMethodInvocationPrimary();  
			break;
 
    case 378 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= super DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationSuperWithTypeArguments();  
			break;
 
    case 379 : if (DEBUG) { LfwLogger.debug("MethodInvocation ::= super DOT Identifier LPAREN..."); }  //$NON-NLS-1$
		    consumeMethodInvocationSuper();  
			break;
 
    case 380 : if (DEBUG) { LfwLogger.debug("ArrayAccess ::= Name LBRACKET Expression RBRACKET"); }  //$NON-NLS-1$
		    consumeArrayAccess(true);  
			break;
 
    case 381 : if (DEBUG) { LfwLogger.debug("ArrayAccess ::= PrimaryNoNewArray LBRACKET Expression..."); }  //$NON-NLS-1$
		    consumeArrayAccess(false);  
			break;
 
    case 382 : if (DEBUG) { LfwLogger.debug("ArrayAccess ::= ArrayCreationWithArrayInitializer..."); }  //$NON-NLS-1$
		    consumeArrayAccess(false);  
			break;
 
    case 384 : if (DEBUG) { LfwLogger.debug("PostfixExpression ::= Name"); }  //$NON-NLS-1$
		    consumePostfixExpression();  
			break;
 
    case 387 : if (DEBUG) { LfwLogger.debug("PostIncrementExpression ::= PostfixExpression PLUS_PLUS"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS,true);  
			break;
 
    case 388 : if (DEBUG) { LfwLogger.debug("PostDecrementExpression ::= PostfixExpression..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS,true);  
			break;
 
    case 389 : if (DEBUG) { LfwLogger.debug("PushPosition ::="); }  //$NON-NLS-1$
		    consumePushPosition();  
			break;
 
    case 392 : if (DEBUG) { LfwLogger.debug("UnaryExpression ::= PLUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS);  
			break;
 
    case 393 : if (DEBUG) { LfwLogger.debug("UnaryExpression ::= MINUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS);  
			break;
 
    case 395 : if (DEBUG) { LfwLogger.debug("PreIncrementExpression ::= PLUS_PLUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS,false);  
			break;
 
    case 396 : if (DEBUG) { LfwLogger.debug("PreDecrementExpression ::= MINUS_MINUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS,false);  
			break;
 
    case 398 : if (DEBUG) { LfwLogger.debug("UnaryExpressionNotPlusMinus ::= TWIDDLE PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.TWIDDLE);  
			break;
 
    case 399 : if (DEBUG) { LfwLogger.debug("UnaryExpressionNotPlusMinus ::= NOT PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.NOT);  
			break;
 
    case 401 : if (DEBUG) { LfwLogger.debug("CastExpression ::= PushLPAREN PrimitiveType Dimsopt..."); }  //$NON-NLS-1$
		    consumeCastExpressionWithPrimitiveType();  
			break;
 
    case 402 : if (DEBUG) { LfwLogger.debug("CastExpression ::= PushLPAREN Name..."); }  //$NON-NLS-1$
		    consumeCastExpressionWithGenericsArray();  
			break;
 
    case 403 : if (DEBUG) { LfwLogger.debug("CastExpression ::= PushLPAREN Name..."); }  //$NON-NLS-1$
		    consumeCastExpressionWithQualifiedGenericsArray();  
			break;
 
    case 404 : if (DEBUG) { LfwLogger.debug("CastExpression ::= PushLPAREN Name PushRPAREN..."); }  //$NON-NLS-1$
		    consumeCastExpressionLL1();  
			break;
 
    case 405 : if (DEBUG) { LfwLogger.debug("CastExpression ::= PushLPAREN Name Dims PushRPAREN..."); }  //$NON-NLS-1$
		    consumeCastExpressionWithNameArray();  
			break;
 
    case 406 : if (DEBUG) { LfwLogger.debug("OnlyTypeArgumentsForCastExpression ::= OnlyTypeArguments"); }  //$NON-NLS-1$
		    consumeOnlyTypeArgumentsForCastExpression();  
			break;
 
    case 407 : if (DEBUG) { LfwLogger.debug("InsideCastExpression ::="); }  //$NON-NLS-1$
		    consumeInsideCastExpression();  
			break;
 
    case 408 : if (DEBUG) { LfwLogger.debug("InsideCastExpressionLL1 ::="); }  //$NON-NLS-1$
		    consumeInsideCastExpressionLL1();  
			break;
 
    case 409 : if (DEBUG) { LfwLogger.debug("InsideCastExpressionWithQualifiedGenerics ::="); }  //$NON-NLS-1$
		    consumeInsideCastExpressionWithQualifiedGenerics();  
			break;
 
    case 411 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression ::= MultiplicativeExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.MULTIPLY);  
			break;
 
    case 412 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression ::= MultiplicativeExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.DIVIDE);  
			break;
 
    case 413 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression ::= MultiplicativeExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.REMAINDER);  
			break;
 
    case 415 : if (DEBUG) { LfwLogger.debug("AdditiveExpression ::= AdditiveExpression PLUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.PLUS);  
			break;
 
    case 416 : if (DEBUG) { LfwLogger.debug("AdditiveExpression ::= AdditiveExpression MINUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.MINUS);  
			break;
 
    case 418 : if (DEBUG) { LfwLogger.debug("ShiftExpression ::= ShiftExpression LEFT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LEFT_SHIFT);  
			break;
 
    case 419 : if (DEBUG) { LfwLogger.debug("ShiftExpression ::= ShiftExpression RIGHT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.RIGHT_SHIFT);  
			break;
 
    case 420 : if (DEBUG) { LfwLogger.debug("ShiftExpression ::= ShiftExpression UNSIGNED_RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.UNSIGNED_RIGHT_SHIFT);  
			break;
 
    case 422 : if (DEBUG) { LfwLogger.debug("RelationalExpression ::= RelationalExpression LESS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS);  
			break;
 
    case 423 : if (DEBUG) { LfwLogger.debug("RelationalExpression ::= RelationalExpression GREATER..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.GREATER);  
			break;
 
    case 424 : if (DEBUG) { LfwLogger.debug("RelationalExpression ::= RelationalExpression LESS_EQUAL"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS_EQUAL);  
			break;
 
    case 425 : if (DEBUG) { LfwLogger.debug("RelationalExpression ::= RelationalExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.GREATER_EQUAL);  
			break;
 
    case 427 : if (DEBUG) { LfwLogger.debug("InstanceofExpression ::= InstanceofExpression instanceof"); }  //$NON-NLS-1$
		    consumeInstanceOfExpression();  
			break;
 
    case 429 : if (DEBUG) { LfwLogger.debug("EqualityExpression ::= EqualityExpression EQUAL_EQUAL..."); }  //$NON-NLS-1$
		    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);  
			break;
 
    case 430 : if (DEBUG) { LfwLogger.debug("EqualityExpression ::= EqualityExpression NOT_EQUAL..."); }  //$NON-NLS-1$
		    consumeEqualityExpression(OperatorIds.NOT_EQUAL);  
			break;
 
    case 432 : if (DEBUG) { LfwLogger.debug("AndExpression ::= AndExpression AND EqualityExpression"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.AND);  
			break;
 
    case 434 : if (DEBUG) { LfwLogger.debug("ExclusiveOrExpression ::= ExclusiveOrExpression XOR..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.XOR);  
			break;
 
    case 436 : if (DEBUG) { LfwLogger.debug("InclusiveOrExpression ::= InclusiveOrExpression OR..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.OR);  
			break;
 
    case 438 : if (DEBUG) { LfwLogger.debug("ConditionalAndExpression ::= ConditionalAndExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.AND_AND);  
			break;
 
    case 440 : if (DEBUG) { LfwLogger.debug("ConditionalOrExpression ::= ConditionalOrExpression..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.OR_OR);  
			break;
 
    case 442 : if (DEBUG) { LfwLogger.debug("ConditionalExpression ::= ConditionalOrExpression..."); }  //$NON-NLS-1$
		    consumeConditionalExpression(OperatorIds.QUESTIONCOLON) ;  
			break;
 
    case 445 : if (DEBUG) { LfwLogger.debug("Assignment ::= PostfixExpression AssignmentOperator..."); }  //$NON-NLS-1$
		    consumeAssignment();  
			break;
 
    case 447 : if (DEBUG) { LfwLogger.debug("Assignment ::= InvalidArrayInitializerAssignement"); }  //$NON-NLS-1$
		    ignoreExpressionAssignment(); 
			break;
 
    case 448 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(EQUAL);  
			break;
 
    case 449 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= MULTIPLY_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(MULTIPLY);  
			break;
 
    case 450 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= DIVIDE_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(DIVIDE);  
			break;
 
    case 451 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= REMAINDER_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(REMAINDER);  
			break;
 
    case 452 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= PLUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(PLUS);  
			break;
 
    case 453 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= MINUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(MINUS);  
			break;
 
    case 454 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= LEFT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(LEFT_SHIFT);  
			break;
 
    case 455 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(RIGHT_SHIFT);  
			break;
 
    case 456 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= UNSIGNED_RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(UNSIGNED_RIGHT_SHIFT);  
			break;
 
    case 457 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= AND_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(AND);  
			break;
 
    case 458 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= XOR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(XOR);  
			break;
 
    case 459 : if (DEBUG) { LfwLogger.debug("AssignmentOperator ::= OR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(OR);  
			break;
 
    case 463 : if (DEBUG) { LfwLogger.debug("Expressionopt ::="); }  //$NON-NLS-1$
		    consumeEmptyExpression();  
			break;
 
    case 468 : if (DEBUG) { LfwLogger.debug("ClassBodyDeclarationsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyClassBodyDeclarationsopt();  
			break;
 
    case 469 : if (DEBUG) { LfwLogger.debug("ClassBodyDeclarationsopt ::= NestedType..."); }  //$NON-NLS-1$
		    consumeClassBodyDeclarationsopt();  
			break;
 
     case 470 : if (DEBUG) { LfwLogger.debug("Modifiersopt ::="); }  //$NON-NLS-1$
		    consumeDefaultModifiers();  
			break;
 
    case 471 : if (DEBUG) { LfwLogger.debug("Modifiersopt ::= Modifiers"); }  //$NON-NLS-1$
		    consumeModifiers();  
			break;
 
    case 472 : if (DEBUG) { LfwLogger.debug("BlockStatementsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyBlockStatementsopt();  
			break;
 
     case 474 : if (DEBUG) { LfwLogger.debug("Dimsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyDimsopt();  
			break;
 
     case 476 : if (DEBUG) { LfwLogger.debug("ArgumentListopt ::="); }  //$NON-NLS-1$
		    consumeEmptyArgumentListopt();  
			break;
 
    case 480 : if (DEBUG) { LfwLogger.debug("FormalParameterListopt ::="); }  //$NON-NLS-1$
		    consumeFormalParameterListopt();  
			break;
 
     case 484 : if (DEBUG) { LfwLogger.debug("InterfaceMemberDeclarationsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyInterfaceMemberDeclarationsopt();  
			break;
 
     case 485 : if (DEBUG) { LfwLogger.debug("InterfaceMemberDeclarationsopt ::= NestedType..."); }  //$NON-NLS-1$
		    consumeInterfaceMemberDeclarationsopt();  
			break;
 
    case 486 : if (DEBUG) { LfwLogger.debug("NestedType ::="); }  //$NON-NLS-1$
		    consumeNestedType();  
			break;

     case 487 : if (DEBUG) { LfwLogger.debug("ForInitopt ::="); }  //$NON-NLS-1$
		    consumeEmptyForInitopt();  
			break;
 
     case 489 : if (DEBUG) { LfwLogger.debug("ForUpdateopt ::="); }  //$NON-NLS-1$
		    consumeEmptyForUpdateopt();  
			break;
 
     case 493 : if (DEBUG) { LfwLogger.debug("Catchesopt ::="); }  //$NON-NLS-1$
		    consumeEmptyCatchesopt();  
			break;
 
     case 495 : if (DEBUG) { LfwLogger.debug("EnumDeclaration ::= EnumHeader EnumBody"); }  //$NON-NLS-1$
		    consumeEnumDeclaration();  
			break;
 
     case 496 : if (DEBUG) { LfwLogger.debug("EnumHeader ::= EnumHeaderName ClassHeaderImplementsopt"); }  //$NON-NLS-1$
		    consumeEnumHeader();  
			break;
 
     case 497 : if (DEBUG) { LfwLogger.debug("EnumHeaderName ::= Modifiersopt enum Identifier"); }  //$NON-NLS-1$
		    consumeEnumHeaderName();  
			break;
 
     case 498 : if (DEBUG) { LfwLogger.debug("EnumHeaderName ::= Modifiersopt enum Identifier..."); }  //$NON-NLS-1$
		    consumeEnumHeaderNameWithTypeParameters();  
			break;
 
     case 499 : if (DEBUG) { LfwLogger.debug("EnumBody ::= LBRACE EnumBodyDeclarationsopt RBRACE"); }  //$NON-NLS-1$
		    consumeEnumBodyNoConstants();  
			break;
 
     case 500 : if (DEBUG) { LfwLogger.debug("EnumBody ::= LBRACE COMMA EnumBodyDeclarationsopt..."); }  //$NON-NLS-1$
		    consumeEnumBodyNoConstants();  
			break;
 
     case 501 : if (DEBUG) { LfwLogger.debug("EnumBody ::= LBRACE EnumConstants COMMA..."); }  //$NON-NLS-1$
		    consumeEnumBodyWithConstants();  
			break;
 
     case 502 : if (DEBUG) { LfwLogger.debug("EnumBody ::= LBRACE EnumConstants..."); }  //$NON-NLS-1$
		    consumeEnumBodyWithConstants();  
			break;
 
    case 504 : if (DEBUG) { LfwLogger.debug("EnumConstants ::= EnumConstants COMMA EnumConstant"); }  //$NON-NLS-1$
		    consumeEnumConstants();  
			break;
 
    case 505 : if (DEBUG) { LfwLogger.debug("EnumConstantHeaderName ::= Modifiersopt Identifier"); }  //$NON-NLS-1$
		    consumeEnumConstantHeaderName();  
			break;
 
    case 506 : if (DEBUG) { LfwLogger.debug("EnumConstantHeader ::= EnumConstantHeaderName..."); }  //$NON-NLS-1$
		    consumeEnumConstantHeader();  
			break;
 
    case 507 : if (DEBUG) { LfwLogger.debug("EnumConstant ::= EnumConstantHeader ForceNoDiet..."); }  //$NON-NLS-1$
		    consumeEnumConstantWithClassBody();  
			break;
 
    case 508 : if (DEBUG) { LfwLogger.debug("EnumConstant ::= EnumConstantHeader"); }  //$NON-NLS-1$
		    consumeEnumConstantNoClassBody();  
			break;
 
    case 509 : if (DEBUG) { LfwLogger.debug("Arguments ::= LPAREN ArgumentListopt RPAREN"); }  //$NON-NLS-1$
		    consumeArguments();  
			break;
 
    case 510 : if (DEBUG) { LfwLogger.debug("Argumentsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyArguments();  
			break;
 
    case 512 : if (DEBUG) { LfwLogger.debug("EnumDeclarations ::= SEMICOLON ClassBodyDeclarationsopt"); }  //$NON-NLS-1$
		    consumeEnumDeclarations();  
			break;
 
    case 513 : if (DEBUG) { LfwLogger.debug("EnumBodyDeclarationsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyEnumDeclarations();  
			break;
 
    case 515 : if (DEBUG) { LfwLogger.debug("EnhancedForStatement ::= EnhancedForStatementHeader..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatement();  
			break;
 
    case 516 : if (DEBUG) { LfwLogger.debug("EnhancedForStatementNoShortIf ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatement();  
			break;
 
    case 517 : if (DEBUG) { LfwLogger.debug("EnhancedForStatementHeaderInit ::= for LPAREN Type..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(false);  
			break;
 
    case 518 : if (DEBUG) { LfwLogger.debug("EnhancedForStatementHeaderInit ::= for LPAREN Modifiers"); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(true);  
			break;
 
    case 519 : if (DEBUG) { LfwLogger.debug("EnhancedForStatementHeader ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeader();  
			break;
 
    case 520 : if (DEBUG) { LfwLogger.debug("SingleStaticImportDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeImportDeclaration();  
			break;
 
    case 521 : if (DEBUG) { LfwLogger.debug("SingleStaticImportDeclarationName ::= import static Name"); }  //$NON-NLS-1$
		    consumeSingleStaticImportDeclarationName();  
			break;
 
    case 522 : if (DEBUG) { LfwLogger.debug("StaticImportOnDemandDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeImportDeclaration();  
			break;
 
    case 523 : if (DEBUG) { LfwLogger.debug("StaticImportOnDemandDeclarationName ::= import static..."); }  //$NON-NLS-1$
		    consumeStaticImportOnDemandDeclarationName();  
			break;
 
    case 524 : if (DEBUG) { LfwLogger.debug("TypeArguments ::= LESS TypeArgumentList1"); }  //$NON-NLS-1$
		    consumeTypeArguments();  
			break;
 
    case 525 : if (DEBUG) { LfwLogger.debug("OnlyTypeArguments ::= LESS TypeArgumentList1"); }  //$NON-NLS-1$
		    consumeOnlyTypeArguments();  
			break;
 
    case 527 : if (DEBUG) { LfwLogger.debug("TypeArgumentList1 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
		    consumeTypeArgumentList1();  
			break;
 
    case 529 : if (DEBUG) { LfwLogger.debug("TypeArgumentList ::= TypeArgumentList COMMA TypeArgument"); }  //$NON-NLS-1$
		    consumeTypeArgumentList();  
			break;
 
    case 530 : if (DEBUG) { LfwLogger.debug("TypeArgument ::= ReferenceType"); }  //$NON-NLS-1$
		    consumeTypeArgument();  
			break;
 
    case 534 : if (DEBUG) { LfwLogger.debug("ReferenceType1 ::= ReferenceType GREATER"); }  //$NON-NLS-1$
		    consumeReferenceType1();  
			break;
 
    case 535 : if (DEBUG) { LfwLogger.debug("ReferenceType1 ::= ClassOrInterface LESS..."); }  //$NON-NLS-1$
		    consumeTypeArgumentReferenceType1();  
			break;
 
    case 537 : if (DEBUG) { LfwLogger.debug("TypeArgumentList2 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
		    consumeTypeArgumentList2();  
			break;
 
    case 540 : if (DEBUG) { LfwLogger.debug("ReferenceType2 ::= ReferenceType RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeReferenceType2();  
			break;
 
    case 541 : if (DEBUG) { LfwLogger.debug("ReferenceType2 ::= ClassOrInterface LESS..."); }  //$NON-NLS-1$
		    consumeTypeArgumentReferenceType2();  
			break;
 
    case 543 : if (DEBUG) { LfwLogger.debug("TypeArgumentList3 ::= TypeArgumentList COMMA..."); }  //$NON-NLS-1$
		    consumeTypeArgumentList3();  
			break;
 
    case 546 : if (DEBUG) { LfwLogger.debug("ReferenceType3 ::= ReferenceType UNSIGNED_RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeReferenceType3();  
			break;
 
    case 547 : if (DEBUG) { LfwLogger.debug("Wildcard ::= QUESTION"); }  //$NON-NLS-1$
		    consumeWildcard();  
			break;
 
    case 548 : if (DEBUG) { LfwLogger.debug("Wildcard ::= QUESTION WildcardBounds"); }  //$NON-NLS-1$
		    consumeWildcardWithBounds();  
			break;
 
    case 549 : if (DEBUG) { LfwLogger.debug("WildcardBounds ::= extends ReferenceType"); }  //$NON-NLS-1$
		    consumeWildcardBoundsExtends();  
			break;
 
    case 550 : if (DEBUG) { LfwLogger.debug("WildcardBounds ::= super ReferenceType"); }  //$NON-NLS-1$
		    consumeWildcardBoundsSuper();  
			break;
 
    case 551 : if (DEBUG) { LfwLogger.debug("Wildcard1 ::= QUESTION GREATER"); }  //$NON-NLS-1$
		    consumeWildcard1();  
			break;
 
    case 552 : if (DEBUG) { LfwLogger.debug("Wildcard1 ::= QUESTION WildcardBounds1"); }  //$NON-NLS-1$
		    consumeWildcard1WithBounds();  
			break;
 
    case 553 : if (DEBUG) { LfwLogger.debug("WildcardBounds1 ::= extends ReferenceType1"); }  //$NON-NLS-1$
		    consumeWildcardBounds1Extends();  
			break;
 
    case 554 : if (DEBUG) { LfwLogger.debug("WildcardBounds1 ::= super ReferenceType1"); }  //$NON-NLS-1$
		    consumeWildcardBounds1Super();  
			break;
 
    case 555 : if (DEBUG) { LfwLogger.debug("Wildcard2 ::= QUESTION RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeWildcard2();  
			break;
 
    case 556 : if (DEBUG) { LfwLogger.debug("Wildcard2 ::= QUESTION WildcardBounds2"); }  //$NON-NLS-1$
		    consumeWildcard2WithBounds();  
			break;
 
    case 557 : if (DEBUG) { LfwLogger.debug("WildcardBounds2 ::= extends ReferenceType2"); }  //$NON-NLS-1$
		    consumeWildcardBounds2Extends();  
			break;
 
    case 558 : if (DEBUG) { LfwLogger.debug("WildcardBounds2 ::= super ReferenceType2"); }  //$NON-NLS-1$
		    consumeWildcardBounds2Super();  
			break;
 
    case 559 : if (DEBUG) { LfwLogger.debug("Wildcard3 ::= QUESTION UNSIGNED_RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeWildcard3();  
			break;
 
    case 560 : if (DEBUG) { LfwLogger.debug("Wildcard3 ::= QUESTION WildcardBounds3"); }  //$NON-NLS-1$
		    consumeWildcard3WithBounds();  
			break;
 
    case 561 : if (DEBUG) { LfwLogger.debug("WildcardBounds3 ::= extends ReferenceType3"); }  //$NON-NLS-1$
		    consumeWildcardBounds3Extends();  
			break;
 
    case 562 : if (DEBUG) { LfwLogger.debug("WildcardBounds3 ::= super ReferenceType3"); }  //$NON-NLS-1$
		    consumeWildcardBounds3Super();  
			break;
 
    case 563 : if (DEBUG) { LfwLogger.debug("TypeParameterHeader ::= Identifier"); }  //$NON-NLS-1$
		    consumeTypeParameterHeader();  
			break;
 
    case 564 : if (DEBUG) { LfwLogger.debug("TypeParameters ::= LESS TypeParameterList1"); }  //$NON-NLS-1$
		    consumeTypeParameters();  
			break;
 
    case 566 : if (DEBUG) { LfwLogger.debug("TypeParameterList ::= TypeParameterList COMMA..."); }  //$NON-NLS-1$
		    consumeTypeParameterList();  
			break;
 
    case 568 : if (DEBUG) { LfwLogger.debug("TypeParameter ::= TypeParameterHeader extends..."); }  //$NON-NLS-1$
		    consumeTypeParameterWithExtends();  
			break;
 
    case 569 : if (DEBUG) { LfwLogger.debug("TypeParameter ::= TypeParameterHeader extends..."); }  //$NON-NLS-1$
		    consumeTypeParameterWithExtendsAndBounds();  
			break;
 
    case 571 : if (DEBUG) { LfwLogger.debug("AdditionalBoundList ::= AdditionalBoundList..."); }  //$NON-NLS-1$
		    consumeAdditionalBoundList();  
			break;
 
    case 572 : if (DEBUG) { LfwLogger.debug("AdditionalBound ::= AND ReferenceType"); }  //$NON-NLS-1$
		    consumeAdditionalBound();  
			break;
 
    case 574 : if (DEBUG) { LfwLogger.debug("TypeParameterList1 ::= TypeParameterList COMMA..."); }  //$NON-NLS-1$
		    consumeTypeParameterList1();  
			break;
 
    case 575 : if (DEBUG) { LfwLogger.debug("TypeParameter1 ::= TypeParameterHeader GREATER"); }  //$NON-NLS-1$
		    consumeTypeParameter1();  
			break;
 
    case 576 : if (DEBUG) { LfwLogger.debug("TypeParameter1 ::= TypeParameterHeader extends..."); }  //$NON-NLS-1$
		    consumeTypeParameter1WithExtends();  
			break;
 
    case 577 : if (DEBUG) { LfwLogger.debug("TypeParameter1 ::= TypeParameterHeader extends..."); }  //$NON-NLS-1$
		    consumeTypeParameter1WithExtendsAndBounds();  
			break;
 
    case 579 : if (DEBUG) { LfwLogger.debug("AdditionalBoundList1 ::= AdditionalBoundList..."); }  //$NON-NLS-1$
		    consumeAdditionalBoundList1();  
			break;
 
    case 580 : if (DEBUG) { LfwLogger.debug("AdditionalBound1 ::= AND ReferenceType1"); }  //$NON-NLS-1$
		    consumeAdditionalBound1();  
			break;
 
    case 586 : if (DEBUG) { LfwLogger.debug("UnaryExpression_NotName ::= PLUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS);  
			break;
 
    case 587 : if (DEBUG) { LfwLogger.debug("UnaryExpression_NotName ::= MINUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS);  
			break;
 
    case 590 : if (DEBUG) { LfwLogger.debug("UnaryExpressionNotPlusMinus_NotName ::= TWIDDLE..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.TWIDDLE);  
			break;
 
    case 591 : if (DEBUG) { LfwLogger.debug("UnaryExpressionNotPlusMinus_NotName ::= NOT PushPosition"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.NOT);  
			break;
 
    case 594 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.MULTIPLY);  
			break;
 
    case 595 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::= Name MULTIPLY..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.MULTIPLY);  
			break;
 
    case 596 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.DIVIDE);  
			break;
 
    case 597 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::= Name DIVIDE..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.DIVIDE);  
			break;
 
    case 598 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.REMAINDER);  
			break;
 
    case 599 : if (DEBUG) { LfwLogger.debug("MultiplicativeExpression_NotName ::= Name REMAINDER..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.REMAINDER);  
			break;
 
    case 601 : if (DEBUG) { LfwLogger.debug("AdditiveExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.PLUS);  
			break;
 
    case 602 : if (DEBUG) { LfwLogger.debug("AdditiveExpression_NotName ::= Name PLUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.PLUS);  
			break;
 
    case 603 : if (DEBUG) { LfwLogger.debug("AdditiveExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.MINUS);  
			break;
 
    case 604 : if (DEBUG) { LfwLogger.debug("AdditiveExpression_NotName ::= Name MINUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.MINUS);  
			break;
 
    case 606 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= ShiftExpression_NotName..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LEFT_SHIFT);  
			break;
 
    case 607 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= Name LEFT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.LEFT_SHIFT);  
			break;
 
    case 608 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= ShiftExpression_NotName..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.RIGHT_SHIFT);  
			break;
 
    case 609 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= Name RIGHT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.RIGHT_SHIFT);  
			break;
 
    case 610 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= ShiftExpression_NotName..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.UNSIGNED_RIGHT_SHIFT);  
			break;
 
    case 611 : if (DEBUG) { LfwLogger.debug("ShiftExpression_NotName ::= Name UNSIGNED_RIGHT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.UNSIGNED_RIGHT_SHIFT);  
			break;
 
    case 613 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= ShiftExpression_NotName"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS);  
			break;
 
    case 614 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= Name LESS..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.LESS);  
			break;
 
    case 615 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= ShiftExpression_NotName"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.GREATER);  
			break;
 
    case 616 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= Name GREATER..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.GREATER);  
			break;
 
    case 617 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS_EQUAL);  
			break;
 
    case 618 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= Name LESS_EQUAL..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.LESS_EQUAL);  
			break;
 
    case 619 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.GREATER_EQUAL);  
			break;
 
    case 620 : if (DEBUG) { LfwLogger.debug("RelationalExpression_NotName ::= Name GREATER_EQUAL..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.GREATER_EQUAL);  
			break;
 
    case 622 : if (DEBUG) { LfwLogger.debug("InstanceofExpression_NotName ::= Name instanceof..."); }  //$NON-NLS-1$
		    consumeInstanceOfExpressionWithName();  
			break;
 
    case 623 : if (DEBUG) { LfwLogger.debug("InstanceofExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeInstanceOfExpression();  
			break;
 
    case 625 : if (DEBUG) { LfwLogger.debug("EqualityExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeEqualityExpression(OperatorIds.EQUAL_EQUAL);  
			break;
 
    case 626 : if (DEBUG) { LfwLogger.debug("EqualityExpression_NotName ::= Name EQUAL_EQUAL..."); }  //$NON-NLS-1$
		    consumeEqualityExpressionWithName(OperatorIds.EQUAL_EQUAL);  
			break;
 
    case 627 : if (DEBUG) { LfwLogger.debug("EqualityExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeEqualityExpression(OperatorIds.NOT_EQUAL);  
			break;
 
    case 628 : if (DEBUG) { LfwLogger.debug("EqualityExpression_NotName ::= Name NOT_EQUAL..."); }  //$NON-NLS-1$
		    consumeEqualityExpressionWithName(OperatorIds.NOT_EQUAL);  
			break;
 
    case 630 : if (DEBUG) { LfwLogger.debug("AndExpression_NotName ::= AndExpression_NotName AND..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.AND);  
			break;
 
    case 631 : if (DEBUG) { LfwLogger.debug("AndExpression_NotName ::= Name AND EqualityExpression"); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.AND);  
			break;
 
    case 633 : if (DEBUG) { LfwLogger.debug("ExclusiveOrExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.XOR);  
			break;
 
    case 634 : if (DEBUG) { LfwLogger.debug("ExclusiveOrExpression_NotName ::= Name XOR AndExpression"); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.XOR);  
			break;
 
    case 636 : if (DEBUG) { LfwLogger.debug("InclusiveOrExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.OR);  
			break;
 
    case 637 : if (DEBUG) { LfwLogger.debug("InclusiveOrExpression_NotName ::= Name OR..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.OR);  
			break;
 
    case 639 : if (DEBUG) { LfwLogger.debug("ConditionalAndExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.AND_AND);  
			break;
 
    case 640 : if (DEBUG) { LfwLogger.debug("ConditionalAndExpression_NotName ::= Name AND_AND..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.AND_AND);  
			break;
 
    case 642 : if (DEBUG) { LfwLogger.debug("ConditionalOrExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.OR_OR);  
			break;
 
    case 643 : if (DEBUG) { LfwLogger.debug("ConditionalOrExpression_NotName ::= Name OR_OR..."); }  //$NON-NLS-1$
		    consumeBinaryExpressionWithName(OperatorIds.OR_OR);  
			break;
 
    case 645 : if (DEBUG) { LfwLogger.debug("ConditionalExpression_NotName ::=..."); }  //$NON-NLS-1$
		    consumeConditionalExpression(OperatorIds.QUESTIONCOLON) ;  
			break;
 
    case 646 : if (DEBUG) { LfwLogger.debug("ConditionalExpression_NotName ::= Name QUESTION..."); }  //$NON-NLS-1$
		    consumeConditionalExpressionWithName(OperatorIds.QUESTIONCOLON) ;  
			break;
 
    case 650 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclarationHeaderName ::= Modifiers AT..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclarationHeaderName() ;  
			break;
 
    case 651 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclarationHeaderName ::= Modifiers AT..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclarationHeaderNameWithTypeParameters() ;  
			break;
 
    case 652 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclarationHeaderName ::= AT..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclarationHeaderNameWithTypeParameters() ;  
			break;
 
    case 653 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclarationHeaderName ::= AT..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclarationHeaderName() ;  
			break;
 
    case 654 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclarationHeader ::=..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclarationHeader() ;  
			break;
 
    case 655 : if (DEBUG) { LfwLogger.debug("AnnotationTypeDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeDeclaration() ;  
			break;
 
    case 657 : if (DEBUG) { LfwLogger.debug("AnnotationTypeMemberDeclarationsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyAnnotationTypeMemberDeclarationsopt() ;  
			break;
 
    case 658 : if (DEBUG) { LfwLogger.debug("AnnotationTypeMemberDeclarationsopt ::= NestedType..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeMemberDeclarationsopt() ;  
			break;
 
    case 660 : if (DEBUG) { LfwLogger.debug("AnnotationTypeMemberDeclarations ::=..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeMemberDeclarations() ;  
			break;
 
    case 661 : if (DEBUG) { LfwLogger.debug("AnnotationMethodHeaderName ::= Modifiersopt..."); }  //$NON-NLS-1$
		    consumeMethodHeaderNameWithTypeParameters(true);  
			break;
 
    case 662 : if (DEBUG) { LfwLogger.debug("AnnotationMethodHeaderName ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeMethodHeaderName(true);  
			break;
 
    case 663 : if (DEBUG) { LfwLogger.debug("AnnotationMethodHeaderDefaultValueopt ::="); }  //$NON-NLS-1$
		    consumeEmptyMethodHeaderDefaultValue() ;  
			break;
 
    case 664 : if (DEBUG) { LfwLogger.debug("AnnotationMethodHeaderDefaultValueopt ::= DefaultValue"); }  //$NON-NLS-1$
		    consumeMethodHeaderDefaultValue();  
			break;
 
    case 665 : if (DEBUG) { LfwLogger.debug("AnnotationMethodHeader ::= AnnotationMethodHeaderName..."); }  //$NON-NLS-1$
		    consumeMethodHeader();  
			break;
 
    case 666 : if (DEBUG) { LfwLogger.debug("AnnotationTypeMemberDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeAnnotationTypeMemberDeclaration() ;  
			break;
 
    case 674 : if (DEBUG) { LfwLogger.debug("AnnotationName ::= AT Name"); }  //$NON-NLS-1$
		    consumeAnnotationName() ;  
			break;
 
    case 675 : if (DEBUG) { LfwLogger.debug("NormalAnnotation ::= AnnotationName LPAREN..."); }  //$NON-NLS-1$
		    consumeNormalAnnotation() ;  
			break;
 
    case 676 : if (DEBUG) { LfwLogger.debug("MemberValuePairsopt ::="); }  //$NON-NLS-1$
		    consumeEmptyMemberValuePairsopt() ;  
			break;
 
    case 679 : if (DEBUG) { LfwLogger.debug("MemberValuePairs ::= MemberValuePairs COMMA..."); }  //$NON-NLS-1$
		    consumeMemberValuePairs() ;  
			break;
 
    case 680 : if (DEBUG) { LfwLogger.debug("MemberValuePair ::= SimpleName EQUAL EnterMemberValue..."); }  //$NON-NLS-1$
		    consumeMemberValuePair() ;  
			break;
 
    case 681 : if (DEBUG) { LfwLogger.debug("EnterMemberValue ::="); }  //$NON-NLS-1$
		    consumeEnterMemberValue() ;  
			break;
 
    case 682 : if (DEBUG) { LfwLogger.debug("ExitMemberValue ::="); }  //$NON-NLS-1$
		    consumeExitMemberValue() ;  
			break;
 
    case 684 : if (DEBUG) { LfwLogger.debug("MemberValue ::= Name"); }  //$NON-NLS-1$
		    consumeMemberValueAsName() ;  
			break;
 
    case 687 : if (DEBUG) { LfwLogger.debug("MemberValueArrayInitializer ::=..."); }  //$NON-NLS-1$
		    consumeMemberValueArrayInitializer() ;  
			break;
 
    case 688 : if (DEBUG) { LfwLogger.debug("MemberValueArrayInitializer ::=..."); }  //$NON-NLS-1$
		    consumeMemberValueArrayInitializer() ;  
			break;
 
    case 689 : if (DEBUG) { LfwLogger.debug("MemberValueArrayInitializer ::=..."); }  //$NON-NLS-1$
		    consumeEmptyMemberValueArrayInitializer() ;  
			break;
 
    case 690 : if (DEBUG) { LfwLogger.debug("MemberValueArrayInitializer ::=..."); }  //$NON-NLS-1$
		    consumeEmptyMemberValueArrayInitializer() ;  
			break;
 
    case 691 : if (DEBUG) { LfwLogger.debug("EnterMemberValueArrayInitializer ::="); }  //$NON-NLS-1$
		    consumeEnterMemberValueArrayInitializer() ;  
			break;
 
    case 693 : if (DEBUG) { LfwLogger.debug("MemberValues ::= MemberValues COMMA MemberValue"); }  //$NON-NLS-1$
		    consumeMemberValues() ;  
			break;
 
    case 694 : if (DEBUG) { LfwLogger.debug("MarkerAnnotation ::= AnnotationName"); }  //$NON-NLS-1$
		    consumeMarkerAnnotation() ;  
			break;
 
    case 695 : if (DEBUG) { LfwLogger.debug("SingleMemberAnnotationMemberValue ::= MemberValue"); }  //$NON-NLS-1$
		    consumeSingleMemberAnnotationMemberValue() ;  
			break;
 
    case 696 : if (DEBUG) { LfwLogger.debug("SingleMemberAnnotation ::= AnnotationName LPAREN..."); }  //$NON-NLS-1$
		    consumeSingleMemberAnnotation() ;  
			break;
 
    case 697 : if (DEBUG) { LfwLogger.debug("RecoveryMethodHeaderName ::= Modifiersopt TypeParameters"); }  //$NON-NLS-1$
		    consumeRecoveryMethodHeaderNameWithTypeParameters();  
			break;
 
    case 698 : if (DEBUG) { LfwLogger.debug("RecoveryMethodHeaderName ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeRecoveryMethodHeaderName();  
			break;
 
    case 699 : if (DEBUG) { LfwLogger.debug("RecoveryMethodHeader ::= RecoveryMethodHeaderName..."); }  //$NON-NLS-1$
		    consumeMethodHeader();  
			break;
 
    case 700 : if (DEBUG) { LfwLogger.debug("RecoveryMethodHeader ::= RecoveryMethodHeaderName..."); }  //$NON-NLS-1$
		    consumeMethodHeader();  
			break;
...
//			this.scanner.commentPtr = -1;
//	}
	//LfwLogger.debug(this.scanner.toStringAction(type));
	switch (type) {
...
protected CompilationUnitDeclaration endParse(int act) {
	...
	if(this.statementRecoveryActivated) {
		...
		if (VERBOSE_RECOVERY){
			LfwLogger.debug(""); 
			LfwLogger.debug("--------------------------");		 //$NON-NLS-1$
			LfwLogger.debug(""+this.compilationUnit);		
			LfwLogger.debug("----------------------------------"); //$NON-NLS-1$
		}
...
public void initialize(boolean initializeNLS) {
	...
	if (this.noAstNodes.length < astLength){
		...
		//LfwLogger.debug("Resized AST stacks : "+ astLength);
	...
	if (this.noExpressions.length < expressionLength){
		...
		//LfwLogger.debug("Resized EXPR stacks : "+ expressionLength);
	}
...
private void jumpOverType(){
	if (this.recoveredTypes != null && this.nextTypeStart > -1 && this.nextTypeStart < this.scanner.currentPosition) {
		...
		if (DEBUG_AUTOMATON) {
			LfwLogger.debug("Jump         -"); //$NON-NLS-1$
		}
...
protected void parse() {
	if (DEBUG) LfwLogger.debug("-- ENTER INSIDE PARSE METHOD --");  //$NON-NLS-1$
	
	if (DEBUG_AUTOMATON) {
		LfwLogger.debug("- Start --------------------------------");  //$NON-NLS-1$
	}
	...
	ProcessTerminals : for (;;) {
		...
		if (act == ERROR_ACTION || this.restartRecovery) {
			...
			if (DEBUG_AUTOMATON) {
				if (this.restartRecovery) {
					LfwLogger.debug("Restart      - "); //$NON-NLS-1$
				} else {
					LfwLogger.debug("Error        - "); //$NON-NLS-1$
				}
			}
		...
		if (act <= NUM_RULES) {
			...
			if (DEBUG_AUTOMATON) {
				LfwLogger.debug("Reduce       - "); //$NON-NLS-1$
			}
			...
			if (DEBUG_AUTOMATON) {
				LfwLogger.debug("Shift/Reduce - (" + name[terminal_index[this.currentToken]]+") ");  //$NON-NLS-1$  //$NON-NLS-2$ 
			}
		    ...
		    if (act < ACCEPT_ACTION) { /* shift */
				...
				if (DEBUG_AUTOMATON) {
					LfwLogger.debug("Shift        - (" + name[terminal_index[this.currentToken]]+")");  //$NON-NLS-1$  //$NON-NLS-2$
				}
				continue ProcessTerminals;
			}
			break ProcessTerminals;
		...
		do { /* reduce */
			...
			if (DEBUG_AUTOMATON) {
				LfwLogger.debug(name[non_terminal_index[lhs[act]]]);
			}
	...
	if (DEBUG) LfwLogger.debug("-- EXIT FROM PARSE METHOD --");  //$NON-NLS-1$
}
...
protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
	...
	if(isDietParse) {
		...
		int[][] intervalToSkip = nc.uap.lfw.ca.jdt.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);
