...
public class BinaryTypeBinding extends ReferenceBinding {
	...
	public static ReferenceBinding resolveType(
			...
			LookupEnvironment lookupEnvironment, boolean b) {
		return null;
	}
//
...
//
///**
// * @see eclipse.jdt.internal.compiler.lookup.ReferenceBinding#availableMethods()
// */
...
//}
///**
// * @see eclipse.jdt.internal.compiler.lookup.TypeBinding#genericTypeSignature()
// */
...
//					return this.memberTypes[i] = (ReferenceBinding) resolveType(memberType, this.environment, false /* no raw conversion */);
...
//
//	for (int i = this.memberTypes.length; --i >= 0;)
//		this.memberTypes[i] = (ReferenceBinding) resolveType(this.memberTypes[i], this.environment, false /* no raw conversion */);
//	this.tagBits &= ~TagBits.HasUnresolvedMemberTypes;
//	return this.memberTypes;
//}
//// NOTE: the return type, arg & exception types of each method of a binary type are resolved when needed
...
//}
	...
	public void resolveTypesFor(MethodBinding currentMethod) {
