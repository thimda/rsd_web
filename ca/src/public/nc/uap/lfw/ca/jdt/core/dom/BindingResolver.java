...
class BindingResolver {
	 ...
	 */
	nc.uap.lfw.ca.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return null;
	}
	 ...
	 */
	IMethodBinding getMethodBinding(nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
		return null;
	}
	 ...
	 */
	IPackageBinding getPackageBinding(nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
		return null;
	}
	 ...
	 */
	ITypeBinding getTypeBinding(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding referenceBinding) {
		return null;
	}
	 ...
	 */
	IVariableBinding getVariableBinding(nc.uap.lfw.ca.jdt.internal.compiler.lookup.VariableBinding binding) {
		return null;
	}
	 ...
	 */
	IAnnotationBinding getAnnotationInstance(nc.uap.lfw.ca.jdt.internal.compiler.lookup.AnnotationBinding instance) {
		return null;
	}
	 ...
	 */
	void store(ASTNode newNode, nc.uap.lfw.ca.jdt.internal.compiler.ast.ASTNode oldASTNode) {
		// default implementation: do nothing
	}
