...
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocAllocationExpression;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocFieldReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocMessageSend;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocQualifiedTypeReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocReturnStatement;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocSingleNameReference;
import nc.uap.lfw.ca.jdt.internal.compiler.ast.JavadocSingleTypeReference;
...
public class Javadoc extends ASTNode {
	...
	public ASTNode getNodeStartingAt(int start) {
		...
		if (this.seeReferences != null) {
			...
			for (int i=0; i<length; i++) {
				nc.uap.lfw.ca.jdt.internal.compiler.ast.Expression expression = this.seeReferences[i];
	...
	/*
	 * @see eclipse.jdt.internal.compiler.ast.ASTNode#print(int, java.lang.StringBuffer)
	 */
