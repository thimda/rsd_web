...
//		}
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#canBeInstantiated()
	 */
	 ...
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#capture(Scope,int)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#computeId()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#constantPoolName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#debugName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#enclosingType()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.Substitution#environment()
	 */
	public LookupEnvironment environment() {
	...
	/**
     * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#erasure()
     */
    public TypeBinding erasure() {
        return this.type.erasure(); // erasure
    }
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#fieldCount()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#fields()
	 */
	public FieldBinding[] fields() {
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[])
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[], TypeBinding[],CompilationUnitScope)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getMemberType(char[])
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#getMethods(char[])
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#isParameterizedType()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.Substitution#isRawSubstitution()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#memberTypes()
	 */
	public ReferenceBinding[] memberTypes() {
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#methods()
	 */
	public MethodBinding[] methods() {
		if ((tagBits & TagBits.AreMethodsComplete) != 0)
			return this.methods;
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#qualifiedPackageName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#qualifiedSourceName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.Binding#readableName()
	 */
	...
	ReferenceBinding resolve() {
		...
		if (this.arguments != null) {
			...
			for (int i = 0; i < argLength; i++)
				this.arguments[i] = BinaryTypeBinding.resolveType((ReferenceBinding) this.arguments[i], this.environment, true /* raw conversion */);
			// arity check
...
//			}
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.Binding#shortReadableName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#signature()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding#sourceName()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.Substitution#substitute(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeVariableBinding)
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#superclass()
	 */
	public ReferenceBinding superclass() {
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces()
	 */
	public ReferenceBinding[] superInterfaces() {
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes()
	 */
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables()
	 */
