...
import nc.uap.lfw.ca.jdt.internal.compiler.lookup.BinaryTypeBinding;
...
import nc.uap.lfw.ca.jdt.internal.compiler.lookup.UnresolvedReferenceBinding;
...
//						}		
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.TypeBinding#erasure()
     */
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.TypeBinding#signature()
     */
	...
	/**
     * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding#isSuperclassOf(nc.uap.lfw.ca.jdt.internal.compiler.lookup.ReferenceBinding)
     */
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.Binding#readableName()
     */
	...
	ReferenceBinding resolve() {
	    ...
	    switch(this.boundKind) {
	        case Wildcard.EXTENDS :
				this.bound = BinaryTypeBinding.resolveType((ReferenceBinding) this.bound, this.environment, true /* raw conversion */);
	        	for (int i = 0, length = this.otherBounds == null ? 0 : this.otherBounds.length; i < length; i++) {
					this.otherBounds[i]= BinaryTypeBinding.resolveType((ReferenceBinding) this.bound, this.environment, true /* raw conversion */);
	        	}
				break;
	        case Wildcard.SUPER :
				this.bound = BinaryTypeBinding.resolveType((ReferenceBinding) this.bound, this.environment, true /* raw conversion */);
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.Binding#shortReadableName()
     */
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.ReferenceBinding#sourceName()
     */
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.TypeVariableBinding#superclass()
     */
    ...
    /* (non-Javadoc)
     * @see eclipse.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces()
     */
