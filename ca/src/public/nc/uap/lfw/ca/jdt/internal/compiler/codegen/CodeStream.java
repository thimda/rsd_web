 ...
 *******************************************************************************/
package nc.uap.lfw.ca.jdt.internal.compiler.codegen;
...
//}
//public void aaload() {
//	if (DEBUG) LfwLogger.error(position + "\t\taaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
...
//}
//public void aastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\taastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\taconst_null"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
...
//	if (DEBUG) LfwLogger.error(position + "\t\taload:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void aload_0() {
//	if (DEBUG) LfwLogger.error(position + "\t\taload_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax) {
//		stackMax = stackDepth;
...
//}
//public void aload_1() {
//	if (DEBUG) LfwLogger.error(position + "\t\taload_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void aload_2() {
//	if (DEBUG) LfwLogger.error(position + "\t\taload_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void aload_3() {
//	if (DEBUG) LfwLogger.error(position + "\t\taload_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tanewarray: " + typeBinding); //$NON-NLS-1$
//	countLabels = 0;
...
//}
//public void areturn() {
//	if (DEBUG) LfwLogger.error(position + "\t\tareturn"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tarraylength"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tastore:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= iArg) {
//		maxLocals = iArg + 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tastore_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals == 0) {
//		maxLocals = 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tastore_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 1) {
//		maxLocals = 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tastore_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 2) {
//		maxLocals = 3;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tastore_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 3) {
//		maxLocals = 4;
...
//}
//public void athrow() {
//	if (DEBUG) LfwLogger.error(position + "\t\tathrow"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void baload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tbaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void bastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tbastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tbipush "+b); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void caload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tcaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void castore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tcastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tcheckcast:"+typeBinding.debugName()); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset + 2 >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void d2f() {
//	if (DEBUG) LfwLogger.error(position + "\t\td2f"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void d2i() {
//	if (DEBUG) LfwLogger.error(position + "\t\td2i"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void d2l() {
//	if (DEBUG) LfwLogger.error(position + "\t\td2l"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void dadd() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdadd"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void daload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdaload"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void dastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 4;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void dcmpg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdcmpg"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void dcmpl() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdcmpl"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdconst_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdconst_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void ddiv() {
//	if (DEBUG) LfwLogger.error(position + "\t\tddiv"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdload:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dload_0() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdload_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dload_1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdload_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dload_2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdload_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dload_3() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdload_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dmul() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdmul"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void dneg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdneg"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void drem() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdrem"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void dreturn() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdreturn"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	// the stackDepth should be equal to 0 
//	if (classFileOffset >= bCodeStream.length) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdstore:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals <= iArg + 1) {
//		maxLocals = iArg + 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdstore_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 2) {
//		maxLocals = 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdstore_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 3) {
//		maxLocals = 3;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdstore_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 4) {
//		maxLocals = 4;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tdstore_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 5) {
//		maxLocals = 5;
...
//}
//public void dsub() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdsub"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void dup() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax) {
//		stackMax = stackDepth;
...
//}
//public void dup_x1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup_x1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dup_x2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup_x2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dup2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dup2_x1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup2_x1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void dup2_x2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tdup2_x2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void f2d() {
//	if (DEBUG) LfwLogger.error(position + "\t\tf2d"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void f2i() {
//	if (DEBUG) LfwLogger.error(position + "\t\tf2i"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void f2l() {
//	if (DEBUG) LfwLogger.error(position + "\t\tf2l"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void fadd() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfadd"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void faload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void fcmpg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfcmpg"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void fcmpl() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfcmpl"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfconst_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfconst_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfconst_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void fdiv() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfdiv"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfload:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= iArg) {
//		maxLocals = iArg + 1;
...
//}
//public void fload_0() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfload_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals == 0) {
//		maxLocals = 1;
...
//}
//public void fload_1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfload_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 1) {
//		maxLocals = 2;
...
//}
//public void fload_2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfload_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 2) {
//		maxLocals = 3;
...
//}
//public void fload_3() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfload_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 3) {
//		maxLocals = 4;
...
//}
//public void fmul() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfmul"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void fneg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfneg"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void frem() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfrem"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void freturn() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfreturn"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	// the stackDepth should be equal to 0 
//	if (classFileOffset >= bCodeStream.length) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfstore:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= iArg) {
//		maxLocals = iArg + 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfstore_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals == 0) {
//		maxLocals = 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfstore_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 1) {
//		maxLocals = 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfstore_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 2) {
//		maxLocals = 3;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tfstore_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 3) {
//		maxLocals = 4;
...
//
//public void fsub() {
//	if (DEBUG) LfwLogger.error(position + "\t\tfsub"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//    			if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Byte.valueOf(byte)"); //$NON-NLS-1$
...
//            } else {
//               // new Byte( byte )
//    			if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Byte(byte)"); //$NON-NLS-1$
...
//    			if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Short.valueOf(short)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    1, // argCount
//                    1, // return type size
...
//            } else {
//                // new Short(short)
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Short(short)"); //$NON-NLS-1$
//            	newWrapperFor(unboxedTypeID);                
//                dup_x1();
//                swap();             
//                this.invoke(
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Character.valueOf(char)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    1, // argCount
//                    1, // return type size
...
//            } else {
//                // new Char( char )
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Character(char)"); //$NON-NLS-1$
//                newWrapperFor(unboxedTypeID);
//                dup_x1();
//                swap();
//                this.invoke(
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Integer.valueOf(int)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    1, // argCount
//                    1, // return type size
...
//            } else {
//                // new Integer(int)
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Integer(int)"); //$NON-NLS-1$
//                newWrapperFor(unboxedTypeID);
//                dup_x1();
//                swap();             
//                this.invoke(
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Long.valueOf(long)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    2, // argCount
//                    1, // return type size
...
//            } else {
//                // new Long( long )
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Long(long)"); //$NON-NLS-1$
//                newWrapperFor(unboxedTypeID);
//                dup_x2();
//                dup_x2();
//                pop();
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Float.valueOf(float)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    1, // argCount
//                    1, // return type size
...
//            } else {
//                // new Float(float)
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Float(float)"); //$NON-NLS-1$
//                newWrapperFor(unboxedTypeID);
//                dup_x1();
//                swap();             
//                this.invoke(
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Double.valueOf(double)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    2, // argCount
//                    1, // return type size
...
//            } else {
//                // new Double( double )
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Double(double)"); //$NON-NLS-1$
//            	newWrapperFor(unboxedTypeID);                
//                dup_x2();
//                dup_x2();
//                pop();
...
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic java.lang.Boolean.valueOf(boolean)"); //$NON-NLS-1$
//                this.invoke(
//                    Opcodes.OPC_invokestatic,
//                    1, // argCount
//                    1, // return type size
...
//            } else {
//                // new Boolean(boolean)
//            	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial java.lang.Boolean(boolean)"); //$NON-NLS-1$
//                newWrapperFor(unboxedTypeID);
//                dup_x1();
//                swap();             
//                this.invoke(
...
//	if (DEBUG) LfwLogger.error(position + "\t\tgetfield:"+fieldBinding); //$NON-NLS-1$
...
//	if (DEBUG) LfwLogger.error(position + "\t\tgetstatic:"+fieldBinding); //$NON-NLS-1$
//	int returnTypeSize = 1;
//	if ((fieldBinding.type.id == TypeIds.T_double) || (fieldBinding.type.id == TypeIds.T_long)) {
//		returnTypeSize = 2;
//	}
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Byte.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangByteConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Short.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangShortConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Character.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangCharacterConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Integer.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangIntegerConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Long.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangLongConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Float.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangFloatConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Double.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangDoubleConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Boolean.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
//					ConstantPool.JavaLangBooleanConstantPoolName,
...
//			if (DEBUG) LfwLogger.error(position + "\t\tgetstatic: java.lang.Void.TYPE"); //$NON-NLS-1$
//			generateFieldAccess(
//					Opcodes.OPC_getstatic,
//					1,
...
//		return;
//	}
//	if (DEBUG) LfwLogger.error(position + "\t\tgoto:"+label); //$NON-NLS-1$
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//				LfwLogger.error("\t\t\t\t<branch chaining - goto eliminated : "+this.position+","+label+">");//$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$				
//			} else {
//				LfwLogger.error("\t\t\t\t<branch chaining - goto issued : "+this.position+","+label+">");//$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
//			}
//		}		
//	}
//	/*
...
//	if (DEBUG) LfwLogger.error(position + "\t\tgotow:"+label); //$NON-NLS-1$
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
//	position++;
...
//}
//public void i2b() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2b"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void i2c() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2c"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void i2d() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2d"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void i2f() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2f"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void i2l() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2l"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void i2s() {
//	if (DEBUG) LfwLogger.error(position + "\t\ti2s"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void iadd() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiadd"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void iaload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void iand() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiand"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void iastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_4"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_5"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\ticonst_m1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void idiv() {
//	if (DEBUG) LfwLogger.error(position + "\t\tidiv"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_acmpeq:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth-=2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_acmpne:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth-=2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_cmpeq:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_icmpge:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_icmpgt:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_icmple:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_icmplt:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tif_icmpne:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifeq:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifge:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifgt:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifle:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tiflt:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifne:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifnonnull:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tifnull:"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (this.wideMode) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tiinc:"+index+","+value); //$NON-NLS-1$ //$NON-NLS-2$
//	countLabels = 0;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tiload:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= iArg) {
//		maxLocals = iArg + 1;
...
//}
//public void iload_0() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiload_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 0) {
//		maxLocals = 1;
...
//}
//public void iload_1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiload_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 1) {
//		maxLocals = 2;
...
//}
//public void iload_2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiload_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 2) {
//		maxLocals = 3;
...
//}
//public void iload_3() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiload_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (maxLocals <= 3) {
//		maxLocals = 4;
...
//}
//public void imul() {
//	if (DEBUG) LfwLogger.error(position + "\t\timul"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void ineg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tineg"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinstance_of:"+typeBinding); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset + 2 >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic: java.lang.Class.forName(Ljava.lang.String;)Ljava.lang.Class;"); //$NON-NLS-1$
//	this.invoke(
//		Opcodes.OPC_invokestatic,
//		1, // argCount
//		1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: "+new String(enumTypeConstantPoolName)+".ordinal()"); //$NON-NLS-1$ //$NON-NLS-2$
//	this.invoke(
//			Opcodes.OPC_invokevirtual,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokeinterface: " + methodBinding); //$NON-NLS-1$
//	countLabels = 0;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial: java.lang.AssertionError.<init>(typeBindingID)V"); //$NON-NLS-1$
//	int argCount = 1;
//	char[] signature = null;
//	switch (typeBindingID) {
//		case TypeIds.T_int :
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial: java.lang.AssertionError.<init>()V"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokespecial,
//			0, // argCount
//			0, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: java.lang.Class.desiredAssertionStatus()Z;"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokevirtual,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic: java.lang.Enum.valueOf(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokestatic,
//			2, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial: java.lang.Error<init>(Ljava.lang.String;)V"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokespecial,
//			1, // argCount
//			0, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokeinterface: java.util.Iterator.hasNext()Z"); //$NON-NLS-1$
//	this.invoke(
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokeinterface: java.util.Iterator.next()java.lang.Object"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokeinterface,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial: java.lang.NoClassDefFoundError.<init>(Ljava.lang.String;)V"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokespecial,
//			1, // argCount
//			0, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: java.lang.Object.getClass()Ljava.lang.Class;"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokevirtual,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokespecial:"+methodBinding); //$NON-NLS-1$
//	countLabels = 0;
//	// initialized to 1 to take into account this immediately
//	int argCount = 1;
//	int id;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic:"+methodBinding); //$NON-NLS-1$
...
//	if (DEBUG) {
//		if (this.targetLevel >= ClassFileConstants.JDK1_5) {
//			LfwLogger.error(position + "\t\tinvokevirtual: java.lang.StringBuilder.append(...)"); //$NON-NLS-1$
//		} else {
//			LfwLogger.error(position + "\t\tinvokevirtual: java.lang.StringBuffer.append(...)"); //$NON-NLS-1$
//		}
//	}
//	int argCount = 1;
//	int returnType = 1;
...
//	if (DEBUG) {
//		if (this.targetLevel >= ClassFileConstants.JDK1_5) {
//			LfwLogger.error(position + "\t\tinvokespecial: java.lang.StringBuilder.<init>()V"); //$NON-NLS-1$
//		} else {
//			LfwLogger.error(position + "\t\tinvokespecial: java.lang.StringBuffer.<init>()V"); //$NON-NLS-1$
//		}
//	}
...
//	if (DEBUG) {
//		if (this.targetLevel >= ClassFileConstants.JDK1_5) {
//			LfwLogger.error(position + "\t\tjava.lang.StringBuilder.<init>(Ljava.lang.String;)V"); //$NON-NLS-1$
//		} else {
//			LfwLogger.error(position + "\t\tjava.lang.StringBuffer.<init>(Ljava.lang.String;)V"); //$NON-NLS-1$
//		}
//	}
//	char[] declaringClass = ConstantPool.JavaLangStringBufferConstantPoolName;
//	if (this.targetLevel >= ClassFileConstants.JDK1_5) {
...
//	if (DEBUG) {
//		if (this.targetLevel >= ClassFileConstants.JDK1_5) {
//			LfwLogger.error(position + "\t\tinvokevirtual: StringBuilder.toString()Ljava.lang.String;"); //$NON-NLS-1$
//		} else {
//			LfwLogger.error(position + "\t\tinvokevirtual: StringBuffer.toString()Ljava.lang.String;"); //$NON-NLS-1$
//		}
//	}
//	char[] declaringClass = ConstantPool.JavaLangStringBufferConstantPoolName;
//	if (this.targetLevel >= ClassFileConstants.JDK1_5) {
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: java.lang.String.intern()"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokevirtual,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokestatic: java.lang.String.valueOf(...)"); //$NON-NLS-1$
//	int argCount = 1;
//	char[] signature = null;
//	switch (typeID) {
//		case TypeIds.T_int :
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: java.lang.System.arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokestatic,
//			5, // argCount
//			0, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual: java.lang.Throwable.getMessage()Ljava.lang.String;"); //$NON-NLS-1$
//	this.invoke(
//			Opcodes.OPC_invokevirtual,
//			0, // argCount
//			1, // return type size
...
//	if (DEBUG) LfwLogger.error(position + "\t\tinvokevirtual:"+methodBinding); //$NON-NLS-1$
//	countLabels = 0;
//	// initialized to 1 to take into account this  immediately
//	int argCount = 1;
//	int id;
...
//}
//public void ior() {
//	if (DEBUG) LfwLogger.error(position + "\t\tior"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void irem() {
//	if (DEBUG) LfwLogger.error(position + "\t\tirem"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void ireturn() {
//	if (DEBUG) LfwLogger.error(position + "\t\tireturn"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	// the stackDepth should be equal to 0 
//	if (classFileOffset >= bCodeStream.length) {
...
//}
//public void ishl() {
//	if (DEBUG) LfwLogger.error(position + "\t\tishl"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void ishr() {
//	if (DEBUG) LfwLogger.error(position + "\t\tishr"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tistore:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= iArg) {
//		maxLocals = iArg + 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tistore_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals == 0) {
//		maxLocals = 1;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tistore_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 1) {
//		maxLocals = 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tistore_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 2) {
//		maxLocals = 3;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tistore_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (maxLocals <= 3) {
//		maxLocals = 4;
...
//}
//public void isub() {
//	if (DEBUG) LfwLogger.error(position + "\t\tisub"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void iushr() {
//	if (DEBUG) LfwLogger.error(position + "\t\tiushr"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void ixor() {
//	if (DEBUG) LfwLogger.error(position + "\t\tixor"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//		return;
//	}
//	if (DEBUG) LfwLogger.error(position + "\t\tjsr"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tjsr_w"+lbl); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void l2d() {
//	if (DEBUG) LfwLogger.error(position + "\t\tl2d"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void l2f() {
//	if (DEBUG) LfwLogger.error(position + "\t\tl2f"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void l2i() {
//	if (DEBUG) LfwLogger.error(position + "\t\tl2i"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void ladd() {
//	if (DEBUG) LfwLogger.error(position + "\t\tladd"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void laload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlaload"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void land() {
//	if (DEBUG) LfwLogger.error(position + "\t\tland"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 4;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lcmp() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlcmp"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlconst_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlconst_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//		stackMax = stackDepth;
//	if (index > 255) {
//		if (DEBUG) LfwLogger.error(position + "\t\tldc_w:"+constant); //$NON-NLS-1$
//		// Generate a ldc_w
//		if (classFileOffset + 2 >= bCodeStream.length) {
//			resizeByteArray();
//		}
...
//		writeUnsignedShort(index);
//	} else {
//		if (DEBUG) LfwLogger.error(position + "\t\tldc:"+constant); //$NON-NLS-1$
//		// Generate a ldc
//		if (classFileOffset + 1 >= bCodeStream.length) {
//			resizeByteArray();
//		}
...
//		stackMax = stackDepth;
//	if (index > 255) {
//		if (DEBUG) LfwLogger.error(position + "\t\tldc_w:"+ typeBinding); //$NON-NLS-1$
//		// Generate a ldc_w
//		if (classFileOffset + 2 >= bCodeStream.length) {
//			resizeByteArray();
//		}
...
//		writeUnsignedShort(index);
//	} else {
//		if (DEBUG) LfwLogger.error(position + "\t\tldw:"+ typeBinding); //$NON-NLS-1$
//		// Generate a ldc
//		if (classFileOffset + 1 >= bCodeStream.length) {
//			resizeByteArray();
//		}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tldc2_w:"+constant); //$NON-NLS-1$
//	countLabels = 0;
//	int index = constantPool.literalIndex(constant);
//	stackDepth += 2;
//	if (stackDepth > stackMax)
...
//	if (index > 255) {
//		// Generate a ldc_w
//		if (DEBUG) LfwLogger.error(position + "\t\tldc_w:"+ new String(constant)); //$NON-NLS-1$
//		if (classFileOffset + 2 >= bCodeStream.length) {
//			resizeByteArray();
//		}
//		position++;
...
//	} else {
//		// Generate a ldc
//		if (DEBUG) LfwLogger.error(position + "\t\tldc:"+ new String(constant)); //$NON-NLS-1$
//		if (classFileOffset + 1 >= bCodeStream.length) {
//			resizeByteArray();
//		}
//		position += 2;
...
//}
//public void ldiv() {
//	if (DEBUG) LfwLogger.error(position + "\t\tldiv"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlload:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (maxLocals <= iArg + 1) {
//		maxLocals = iArg + 2;
...
//}
//public void lload_0() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlload_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (maxLocals < 2) {
//		maxLocals = 2;
...
//}
//public void lload_1() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlload_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (maxLocals < 3) {
//		maxLocals = 3;
...
//}
//public void lload_2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlload_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (maxLocals < 4) {
//		maxLocals = 4;
...
//}
//public void lload_3() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlload_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth += 2;
//	if (maxLocals < 5) {
//		maxLocals = 5;
...
//}
//public void lmul() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlmul"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lneg() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlneg"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlookupswitch"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
...
//}
//public void lor() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlor"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lrem() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlrem"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lreturn() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlreturn"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	// the stackDepth should be equal to 0 
//	if (classFileOffset >= bCodeStream.length) {
...
//}
//public void lshl() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlshl"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lshr() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlshr"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlstore:"+iArg); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals <= iArg + 1) {
//		maxLocals = iArg + 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlstore_0"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 2) {
//		maxLocals = 2;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlstore_1"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 3) {
//		maxLocals = 3;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlstore_2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 4) {
//		maxLocals = 4;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tlstore_3"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (maxLocals < 5) {
//		maxLocals = 5;
...
//}
//public void lsub() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlsub"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lushr() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlushr"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void lxor() {
//	if (DEBUG) LfwLogger.error(position + "\t\tlxor"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tmonitorenter"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tmonitorexit"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tmultinewarray:"+typeBinding+","+dimensions); //$NON-NLS-1$ //$NON-NLS-2$
//	countLabels = 0;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tnew:"+typeBinding.debugName()); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tnewarray:"+array_Type); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset + 1 >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.AssertionError"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	// new: java.lang.Error
//	if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Error"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.NoClassDefFoundError"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//	if (DEBUG) {
//		if (this.targetLevel >= ClassFileConstants.JDK1_5) {
//			LfwLogger.error(position + "\t\tnew: java.lang.StringBuilder"); //$NON-NLS-1$
//		} else {
//			LfwLogger.error(position + "\t\tnew: java.lang.StringBuffer"); //$NON-NLS-1$
//		}
//	}
//	countLabels = 0;
//	stackDepth++;
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Integer"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Boolean"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Byte"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Character"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Float"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Double"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Short"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Long"); //$NON-NLS-1$
...
//			if (DEBUG) LfwLogger.error(position + "\t\tnew: java.lang.Void"); //$NON-NLS-1$
//			writeUnsignedShort(constantPool.literalIndexForType(ConstantPool.JavaLangVoidConstantPoolName));
//	}
//}
//public void nop() {
//	if (DEBUG) LfwLogger.error(position + "\t\tnop"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//}
//public void pop() {
//	if (DEBUG) LfwLogger.error(position + "\t\tpop"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void pop2() {
//	if (DEBUG) LfwLogger.error(position + "\t\tpop2"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 2;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tputfield:"+fieldBinding); //$NON-NLS-1$
//	int returnTypeSize = 1;
//	if ((fieldBinding.type.id == TypeIds.T_double) || (fieldBinding.type.id == TypeIds.T_long)) {
//		returnTypeSize = 2;
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tputstatic:"+fieldBinding); //$NON-NLS-1$
//	int returnTypeSize = 1;
//	if ((fieldBinding.type.id == TypeIds.T_double) || (fieldBinding.type.id == TypeIds.T_long)) {
//		returnTypeSize = 2;
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\tret:"+index); //$NON-NLS-1$
//	countLabels = 0;
//	if (index > 255) { // Widen
//		if (classFileOffset + 3 >= bCodeStream.length) {
//			resizeByteArray();
...
//}
//public void return_() {
//	if (DEBUG) LfwLogger.error(position + "\t\treturn"); //$NON-NLS-1$
//	countLabels = 0;
//	// the stackDepth should be equal to 0 
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void saload() {
//	if (DEBUG) LfwLogger.error(position + "\t\tsaload"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//}
//public void sastore() {
//	if (DEBUG) LfwLogger.error(position + "\t\tsastore"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth -= 3;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
...
//	if (DEBUG) LfwLogger.error(position + "\t\tsipush:"+s); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth++;
//	if (stackDepth > stackMax)
//		stackMax = stackDepth;
...
//}
//public void swap() {
//	if (DEBUG) LfwLogger.error(position + "\t\tswap"); //$NON-NLS-1$
//	countLabels = 0;
//	if (classFileOffset >= bCodeStream.length) {
//		resizeByteArray();
//	}
...
//	if (DEBUG) LfwLogger.error(position + "\t\ttableswitch"); //$NON-NLS-1$
//	countLabels = 0;
//	stackDepth--;
