...
import nc.uap.lfw.ca.jdt.core.IAnnotatable;
...
import nc.uap.lfw.ca.jdt.internal.compiler.util.*;
...
class AnnotationBinding implements IAnnotationBinding {
	...
	private nc.uap.lfw.ca.jdt.internal.compiler.lookup.AnnotationBinding binding;
	private BindingResolver bindingResolver;
	private String key;

	AnnotationBinding(nc.uap.lfw.ca.jdt.internal.compiler.lookup.AnnotationBinding annotation, BindingResolver resolver) {
		if (annotation == null)
