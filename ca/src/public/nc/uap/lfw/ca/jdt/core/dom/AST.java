 ...
 * (see {@link nc.uap.lfw.ca.jdt.core.dom.ASTNode ASTNode} and its subclasses)
...
//	}
	...
	void recordModifications(CompilationUnit root) {
		throw new RuntimeException("这部分被改了");
