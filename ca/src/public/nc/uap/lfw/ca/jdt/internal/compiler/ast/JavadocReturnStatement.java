...
public class JavadocReturnStatement extends ReturnStatement {
	...
	/* (non-Javadoc)
	 * @see eclipse.jdt.internal.compiler.ast.Statement#resolve(eclipse.jdt.internal.compiler.lookup.BlockScope)
	 */
	...
	/* (non-Javadoc)
	 * @see eclipse.jdt.internal.compiler.ast.Statement#printStatement(int, java.lang.StringBuffer)
	 */
