...
public class RawTypeBinding extends ParameterizedTypeBinding {
	...
	/**
	 * @see nc.uap.lfw.ca.jdt.internal.compiler.lookup.ParameterizedTypeBinding#createParameterizedMethod(nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding)
	 */
