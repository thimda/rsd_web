...
import nc.uap.lfw.ca.jdt.internal.compiler.lookup.ImportBinding;
...
class BindingComparator {
	...
	static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
		if (declaringElement instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding) {
			if (!(declaringElement2 instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding)){
				return false;
			}
			return isEqual((nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding) declaringElement,
					(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding) declaringElement2,
					visitedTypes);
		} else if (declaringElement instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding) {
			if (!(declaringElement2 instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding)) {
				return false;
			}
			return isEqual((nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding) declaringElement,
					(nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding) declaringElement2,
					visitedTypes);
		...
		} else if (declaringElement instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding) {
			if (!(declaringElement2 instanceof nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding)) {
				return false;
			}
			nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding = (nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding) declaringElement;
			nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = (nc.uap.lfw.ca.jdt.internal.compiler.lookup.PackageBinding) declaringElement2;
	...
	static boolean isEqual(nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding,
			nc.uap.lfw.ca.jdt.internal.compiler.lookup.MethodBinding methodBinding2) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding[] bindings, nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding[] bindings, nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
		if (bindings == null) {
			return otherBindings == null;
		}
		if (otherBindings == null) {
	...
	static boolean isEqual(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding, nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding, nc.uap.lfw.ca.jdt.internal.compiler.lookup.TypeBinding typeBinding2) {
