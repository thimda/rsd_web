...
<PageMeta caption="userprefs">
    ...
    <Widgets>
        ...
        <Widget id="changetime" refId="changetime">
        </Widget>
    </Widgets>
    <Listeners>
        <PageListener id="userprefs_defaultListener" serverClazz="nc.uap.lfw.core.event.deft.DefaultPageServerListener">
            <Events>
