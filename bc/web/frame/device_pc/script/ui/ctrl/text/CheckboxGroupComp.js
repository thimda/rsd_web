...
CheckboxGroupComp.IMAGE_SIDE_LENGTH = 15;
 ...
 */
CheckboxGroupComp.prototype.addCheckbox = function(text, value, checked, sepWidth, imageSrc) {
	var oThis = this;
	// 索引值
	...
	if(imageSrc){
		...
		realWidth += CheckboxGroupComp.IMAGE_SIDE_LENGTH;
	}
	...
	var checkbox = new CheckboxComp(checkboxDiv, this.id + "_checkbox_" + index, 0, 0, realWidth - 2, text, checked, "relative", null, attrArr);
