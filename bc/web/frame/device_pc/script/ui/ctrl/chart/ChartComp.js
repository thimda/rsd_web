...
ChartComp.prototype.createChart = function(){
	...
	this.chart = new FusionCharts(window.frameGlobalPath + "/ui/ctrl/chart/fusionchart/swf/" + this.chartconfig.showType + ".swf", this.id + Chartindex + "", this.Div_gen.offsetWidth, this.Div_gen.offsetHeight, "0", "0");
