...
MessageComp.HEIGHT = 180;
MessageComp.WIDTH = 350;
...
//	this.width = MessageComp.WIDTH;
//	this.height = MessageComp.HEIGHT;
...
MessageComp.prototype.create = function() {
	...
	this.closeImg.src =  window.themePath+"/ui/ctrl/message/images/message_close.png";
 ...
 * 显示提示信息（外部调用）
 */
MessageComp.showMessage = function(showPosition, text, x, y, className) {
	var width = getTextWidth(text,className);
	width = width + 100;
