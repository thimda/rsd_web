...
MenuItemComp.prototype.setItemWidth = function(eleWidth) {
	...
	this.width = width - 1;
	if (this.isMenuBarItem == true)
		this.Div_gen.style.width = (width + 6) + "px";
	else
...
MenuItemComp.prototype.createRightDiv = function() {
	...
	if(this.isMenuBarItem == true) {
		this.rightImg.style.width = "6px";
		this.rightImg.style.height = "3px";
		this.rightImg.src = window.themePath + "/images/menuitem/down.gif";
		if (!IS_IE || IS_IE8)
			this.rightDiv.style.paddingTop = "3px";
	} 
	//else if(this.isMenuBarItem == false) {
	else {
		this.rightImg.style.width = "8px";
		this.rightImg.style.height = "16px";
		this.rightImg.style.top = "3px";
		this.rightImg.style.position = "relative";
		this.rightImg.src = window.themePath + "/images/menuitem/right.gif";
	}
