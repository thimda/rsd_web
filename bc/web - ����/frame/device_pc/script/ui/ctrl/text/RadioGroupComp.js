...
RadioGroupComp.prototype.manageSelf = function() {
	...
	this.Div_text.style.height = "100%";
 ...
 */
RadioGroupComp.prototype.addRadio = function(text, value, checked, sepWidth) {
	var oThis = this;
	// 索引值
	...
	var radio = new RadioComp(radioDiv, this.id + "_radio_" + index, 0, 0, this.groupId, value, text, checked, "relative");
...
//				checked = true;
			if (i == (nameArr.length - 1))
				sepWidth = 0;
			this.addRadio(nameArr[i], valueArr[i], checked, sepWidth);
		}
	}
