...
CKEDITOR.dialog.add('anchor', function(a) {
			...
			return {
				...
				onOk : function() {
					...
					if (k._.selectedElement) {
						...
						if (h.collapsed) {
							...
							var i = a.document.createElement('a', {
										attributes : e
									});
				...
				onShow : function() {
					...
					if (e) {
						if (CKEDITOR.plugins.link.fakeAnchor) {
							var g = CKEDITOR.plugins.link.tryRestoreFakeAnchor(
									a, e);
							g && b.call(h, g);
