...
CKEDITOR.dialog.add('cellProperties', function(a) {
	...
	function k(l, m) {
		...
		if (a._.storedDialogs.colordialog)
			...
			CKEDITOR.on('dialogDefinition', function(r) {
						...
						r.removeListener();
						s.onLoad = CKEDITOR.tools.override(s.onLoad,
								function(t) {
									return function() {
										q(this);
										s.onLoad = t;
	...
	return {
		...
		minHeight : CKEDITOR.env.ie
				&& (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ? 230 : 200,
		contents : [{
			id : 'info',
			label : c.title,
			accessKey : 'I',
			elements : [{
				...
				children : [{
					...
					children : [{
						...
						children : [{
							...
							onLoad : function() {
								...
								n.setAttribute('aria-labelledby', [o, m.$.id]
												.join(' '));
							},
							setup : function(l) {
								var m = parseInt(l.getAttribute('width'), 10), n = parseInt(
										l.getStyle('width'), 10);
								!isNaN(m) && this.setValue(m);
								!isNaN(n) && this.setValue(n);
							},
							commit : function(l) {
								var m = parseInt(this.getValue(), 10), n = this
										.getDialog().getValueOf('info',
												'widthType');
								if (!isNaN(m))
						...
						children : [{
							...
							setup : function(l) {
								var m = parseInt(l.getAttribute('height'), 10), n = parseInt(
										l.getStyle('height'), 10);
								!isNaN(m) && this.setValue(m);
								!isNaN(n) && this.setValue(n);
							},
							commit : function(l) {
								...
								if (!isNaN(m))
									l.setStyle('height', CKEDITOR.tools
													.cssLength(m));
								else
						...
						setup : function(l) {
							var m = l.getAttribute('noWrap'), n = l
						...
						label : c.hAlign,
						'default' : '',
						items : [[d.notSet, ''], [d.alignLeft, 'left'],
								[d.alignCenter, 'center'],
								[d.alignRight, 'right']],
						setup : function(l) {
							var m = l.getAttribute('align'), n = l
									.getStyle('text-align');
							this.setValue(n || m || '');
						},
						commit : function(l) {
					...
					children : [{
								...
								setup : function(l) {
									var m = parseInt(l.getAttribute('rowSpan'),
											10);
									if (m && m != 1)
										this.setValue(m);
								},
								...
								setup : function(l) {
									var m = parseInt(l.getAttribute('colSpan'),
											10);
									if (m && m != 1)
										this.setValue(m);
								},
								...
								children : [{
									...
									'default' : '',
									setup : function(l) {
										var m = l.getAttribute('bgColor'), n = l
									...
									commit : function(l) {
										var m = this.getValue();
										if (m)
											l.setStyle('background-color', this
															.getValue());
										else
									...
									label : c.chooseColor,
									onLoad : function() {
										this.getElement().getParent().setStyle(
								...
								children : [{
									...
									'default' : '',
									setup : function(l) {
										var m = l.getAttribute('borderColor'), n = l
									...
									'class' : 'colorChooser',
									label : c.chooseColor,
									style : (j ? 'margin-right' : 'margin-left')
											+ ': 10px',
									onLoad : function() {
										this.getElement().getParent().setStyle(
												'vertical-align', 'bottom');
		...
		onShow : function() {
			var l = this;
			l.cells = CKEDITOR.plugins.tabletools.getSelectedCells(l._.editor
					.getSelection());
