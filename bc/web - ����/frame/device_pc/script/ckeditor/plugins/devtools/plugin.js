...
CKEDITOR.plugins.add('devtools', {
	...
	onLoad : function() {
		CKEDITOR.document
				.appendStyleText(CKEDITOR.config.devtools_styles
...
(function() {
	function a(d, e, f, g) {
		var h = d.lang.devTools, i = '<a href="http://docs.cksource.com/ckeditor_api/symbols/CKEDITOR.dialog.definition.'
				+ (f ? f.type == 'text' ? 'textInput' : f.type : 'content')
				+ '.html" target="_blank">' + (f ? f.type : 'content') + '</a>', j = '<h2>'
				+ h.title
				+ '</h2>'
				+ '<ul>'
				+ '<li><strong>'
	...
	CKEDITOR.on('dialogDefinition', function(d) {
		...
		if (e._.showDialogDefinitionTooltips) {
			...
			var f = d.data.definition.dialog, g = e.config.devtools_textCallback
					|| a;
			f.on('load', function() {
						...
						for (var j = 0, k = h.count(); j < k; j++) {
							...
							i.on('mouseover', function() {
										var l = this.$.id;
										b(g, this, e, f, null, l.substring(4,
														l.lastIndexOf('_')));
									});
