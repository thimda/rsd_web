...
//			width = width - 5;
	...
	this.pushImg = $ce("IMG");
	this.pushImg.src = window.themePath + "/images/combobox/combo_nm.gif";
...
//	this.dataDiv.style.zIndex = BaseComponent.STANDARD_ZINDEX + 1000000000;
	...
	if (this.disabled == true) {
		...
		this.pushImg.src = window.themePath
				+ "/images/combobox/combo_disable.gif";
	}
