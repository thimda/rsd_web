...
function showDefaultLoadingBar() {
	if (window.loadingBar == null) {
		var imgSrc = window.themePath + "/ui/control/loading/loading.gif";
...
//		var imgSrc = window.themePath + "/images/loading/loading.swf";
...
//		window.loadingBar.Div_gen.style.backgroundColor="transparent";
		var bgImgSrc = window.themePath + "/../images/transparent.gif";
