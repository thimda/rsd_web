...
CalendarComp.prototype.manageSelf = function() {
	...
	this.nextYearImg.src = window.themePath + "/images/calendar/up.gif";
	this.nextYearImg.className = "calendar_bar_imgup";
	this.yearDiv.appendChild(this.nextYearImg);

	this.preYearImg = $ce("img");
	this.preYearImg.src = window.themePath + "/images/calendar/down.gif";
...
//	this.monthComb.dataDiv.style.zIndex = BaseComponent.STANDARD_ZINDEX + 1000001; 
	...
	this.nextMonButt = new ImageComp(oParent, trans("ml_nextmonth"),
			window.themePath + "/images/calendar/right.gif", tmpLeft, 9, "",
			"", trans("ml_nextmonth"), window.themePath
					+ "/images/calendar/right.gif", null);
	...
	this.preMonButt = new ImageComp(oParent, trans("ml_lastmonth"),
			window.themePath + "/images/calendar/left.gif", tmpLeft, 9, "", "",
			trans("ml_lastmonth"), window.themePath
					+ "/images/calendar/left.gif", null);
 ...
 * 显示日历控件
 */
CalendarComp.prototype.show = function(left, top, showTimeBar) {
	var oThis = this;
	this.left = left;
	this.top = top;
	...
	if (showTimeBar) {
		if (this.timeBar == null) {
			...
			this.preHourImg.src = window.themePath + "/images/calendar/up.gif";
			...
			this.nextHourImg.src = window.themePath
					+ "/images/calendar/down.gif";
...
//			hourText.innerHTML = trans("ml_hour");
			...
			this.preMinImg.src = window.themePath + "/images/calendar/up.gif";
			...
			this.nextMinImg.src = window.themePath
					+ "/images/calendar/down.gif";
...
//			minText.innerHTML = trans("ml_min");
			...
			this.preSecImg.src = window.themePath + "/images/calendar/up.gif";
			...
			this.nextSecImg.src = window.themePath
					+ "/images/calendar/down.gif";
