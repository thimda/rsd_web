...
InputDialogComp.prototype.create = function() {
	...
	if (this.fixHeight) {
		this.contentDiv.style.height = this.height - 80 + "px";
	...
	// 生成取消按钮
	this.cancelBt = new ButtonComp(this.cancelBtDiv, "cancelBt", 0, 0, "70",
			"22", trans("ml_cancel"), "", '', "relative", "", false, "dialog_button_div");
 ...
 */
InputDialogComp.prototype.addItem = function(labelText, inputId, inputType, isMust, attrArr, value) {
	// 创建子项
	var itemDiv = $ce("DIV");
