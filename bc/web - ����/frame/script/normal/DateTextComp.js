...
DateTextComp.prototype.manageSelf = function() {
	...
	this.refImg = $ce("IMG");
	this.refImg.src = window.themePath + '/images/text/date_nm.gif';
	...
	this.divButton.onmouseover = function(e) {
		oThis.refImg.src = window.themePath + "/images/text/date_on.gif";
	};
	
	this.divButton.onmouseout = function(e) {
		oThis.refImg.src = window.themePath + "/images/text/date_nm.gif";
	};
	...
	if (this.disabled) {	
		...
		this.refImg.src = window.themePath + "/images/text/date_disable.gif";
	}
...
DateTextComp.prototype.openCalendar = function(e) {		 
	...
	if (dateValue == "") {
		...
		this.calendar.show(left, top, this.showTimeBar, dateValue);
	}
