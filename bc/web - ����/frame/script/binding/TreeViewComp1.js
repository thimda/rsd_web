...
function TreeViewComp(parent, name, left, top, width, height, position, withCheckBox,
		rootOpen, withRoot, rootNode, className) {
...
//	this.checkBoxModel = TreeViewComp.CHECKBOXMODEL_SELF_SUB; 
//	this.checkBoxModel = TreeViewComp.CHECKBOXMODEL_SELF_SUB_PARENT; 
//	// 当前树是否处于多选模式(内部控制使用)
//	this.multiSelectMode = false;
	// 记录多选时所有选中的节点,便于外观改变时使用
...
function TreeNode(id, caption, value, open, isLeaf, reload, nodeData, withCheckBox, checkBoxModel, canEdit) {
	...
	if (this.isLeaf) {
		...
		this.icon1 = window.themePath + "/images/treeview/folder_off.gif";
		this.icon2 = window.themePath + "/images/treeview/folder_on.gif";
	}
};
 ...
 * @private
 */
TreeNode.prototype.create2 = function() {
 ...
 * @private
 */
TreeNode.generateNodeJsonObj = function(nodeJs, parentNodeId) {
