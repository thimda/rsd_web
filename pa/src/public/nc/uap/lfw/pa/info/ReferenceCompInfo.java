 ...
 * @since 1.6
 */
public class ReferenceCompInfo extends ControlInfo {
	...
	static{
		...
		showValue.setDsField("string_ext14");
		showValue.setLabel("showValue");
		...
		refcode.setDsField("string_ext16");
		refcode.setLabel("refcode");
