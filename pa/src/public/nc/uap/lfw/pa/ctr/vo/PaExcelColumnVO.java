 ...
 * @since 1.6
 */
public class PaExcelColumnVO extends SuperVO {
	
	private static final long serialVersionUID = 1L;

	private String pk_excelcolumn;
	...
	public String getPKFieldName() {
		return "pk_excelcolumn";
	}
	@Override
	public String getTableName() {
		return "pa_excelcolumn";
	}
	public String getPk_excelcolumn() {
		return pk_excelcolumn;
	}
	public void setPk_excelcolumn(String pk_excelcolumn) {
		this.pk_excelcolumn = pk_excelcolumn;
	}
	public String getId() {
		return id;
	}
	...
	public String getPk_columngroup() {
		return pk_columngroup;
	}
	public void setPk_columngroup(String pk_columngroup) {
		this.pk_columngroup = pk_columngroup;
	}
