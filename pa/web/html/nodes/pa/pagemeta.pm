...
<PageMeta caption="个性化设置">
    ...
    <Widgets>
        <Widget id="editor" refId="editor">
        </Widget>
        <Widget id="settings" refId="settings">
        </Widget>
        <Widget id="data" refId="data">
        </Widget>
    </Widgets>
    <Listeners>
        <PageListener id="pa_defaultListener" serverClazz="nc.uap.lfw.core.event.deft.DefaultPageServerListener">
            <Events>
