...
<PageMeta caption="持久化测试">
    ...
    <Widgets>
        ...
        <Widget id="secondView" refId="secondView">
        </Widget>
    </Widgets>
    <Listeners>
        <PageListener id="persistTest_defaultListener" serverClazz="nc.uap.lfw.core.event.deft.DefaultPageServerListener">
            <Events>
